...
public class CustomEntityModelParser {
	...
	public static CustomEntityRenderer parseEntityRender(JsonObject obj, String path) {
		...
		CustomModelRenderer[] acustommodelrenderer = (CustomModelRenderer[]) list
				.toArray(new CustomModelRenderer[list.size()]);
		...
		CustomEntityRenderer customentityrenderer = new CustomEntityRenderer(s, s1, resourcelocation,
				acustommodelrenderer, f);
	...
	public static CustomModelRenderer parseCustomModelRenderer(JsonObject elem, int[] textureSize, String basePath) {
		...
		if (jsonarray != null) {
			...
			if (list.size() > 0) {
				ModelVariableUpdater[] amodelvariableupdater = (ModelVariableUpdater[]) list
						.toArray(new ModelVariableUpdater[list.size()]);
