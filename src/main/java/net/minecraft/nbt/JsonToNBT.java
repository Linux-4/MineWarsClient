...
public class JsonToNBT {
	private static final Pattern field_193615_a = Pattern.compile("[-+]?(?:[0-9]+[.]|[0-9]*[.][0-9]+)(?:e[-+]?[0-9]+)?",
			2);
	private static final Pattern field_193616_b = Pattern
			.compile("[-+]?(?:[0-9]+[.]?|[0-9]*[.][0-9]+)(?:e[-+]?[0-9]+)?d", 2);
	private static final Pattern field_193617_c = Pattern
	...
	private String func_193595_h() throws NBTException {
		...
		while (this.func_193612_g()) {
			...
			if (flag) {
				...
				if (c0 == '"') {
					return stringbuilder == null ? this.field_193622_h.substring(i, this.field_193623_i - 1)
	...
	private String func_193614_i() {
		...
		for (i = this.field_193623_i; this.func_193612_g()
				&& this.func_193599_a(this.func_193598_n()); ++this.field_193623_i) {
			;
		}
	...
	protected NBTBase func_193605_e() throws NBTException {
		return this.func_193608_a(2) && this.func_193597_b(1) != '"' && this.func_193597_b(2) == ';'
				? this.func_193606_k()
				: this.func_193600_j();
	}
		...
		if (!this.func_193612_g()) {
			...
			while (this.func_193598_n() != ']') {
				...
				if (i < 0) {
					...
					throw this.func_193602_b("Unable to insert " + NBTBase.func_193581_j(j) + " into ListTag of type "
							+ NBTBase.func_193581_j(i));
				}
	...
	private <T extends Number> List<T> func_193603_a(byte p_193603_1_, byte p_193603_2_) throws NBTException {
		...
		while (true) {
			if (this.func_193598_n() != ']') {
				...
				if (i != p_193603_2_) {
					throw this.func_193602_b("Unable to insert " + NBTBase.func_193581_j(i) + " into "
							+ NBTBase.func_193581_j(p_193603_1_));
				}
	...
	private void func_193604_b(char p_193604_1_) throws NBTException {
		...
		if (flag && this.func_193598_n() == p_193604_1_) {
			...
			throw new NBTException(
					"Expected '" + p_193604_1_ + "' but got '" + (flag ? this.func_193598_n() : "<EOF>") + "'",
					this.field_193622_h, this.field_193623_i + 1);
		}
	}

	protected boolean func_193599_a(char p_193599_1_) {
		return p_193599_1_ >= '0' && p_193599_1_ <= '9' || p_193599_1_ >= 'A' && p_193599_1_ <= 'Z'
				|| p_193599_1_ >= 'a' && p_193599_1_ <= 'z' || p_193599_1_ == '_' || p_193599_1_ == '-'
				|| p_193599_1_ == '.' || p_193599_1_ == '+';
	}
