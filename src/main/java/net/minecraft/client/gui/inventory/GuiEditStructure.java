...
public class GuiEditStructure extends GuiScreen {
	...
	public void initGui() {
		...
		this.detectSizeButton = this.addButton(new GuiButton(19, this.width / 2 + 4 + 100, 120, 50, 20,
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		this.drawCenteredString(this.fontRendererObj, I18n.format("tile.structureBlock.name"), this.width / 2, 10,
				16777215);

		if (tileentitystructure$mode != TileEntityStructure.Mode.DATA) {
			this.drawString(this.fontRendererObj, I18n.format("structure_block.structure_name"), this.width / 2 - 153,
					30, 10526880);
		...
		if (tileentitystructure$mode == TileEntityStructure.Mode.LOAD
			...
			this.drawString(this.fontRendererObj, I18n.format("structure_block.position"), this.width / 2 - 153, 70,
					10526880);
		...
		if (tileentitystructure$mode == TileEntityStructure.Mode.SAVE) {
			this.drawString(this.fontRendererObj, I18n.format("structure_block.size"), this.width / 2 - 153, 110,
					10526880);
		...
		if (tileentitystructure$mode == TileEntityStructure.Mode.LOAD) {
			this.drawString(this.fontRendererObj, I18n.format("structure_block.integrity"), this.width / 2 - 153, 110,
					10526880);
		...
		if (tileentitystructure$mode == TileEntityStructure.Mode.DATA) {
			this.drawString(this.fontRendererObj, I18n.format("structure_block.custom_data"), this.width / 2 - 153, 110,
					10526880);
