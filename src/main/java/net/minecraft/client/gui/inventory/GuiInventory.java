...
public class GuiInventory extends InventoryEffectRenderer implements IRecipeShownListener {
	...
	public void initGui() {
		...
		this.field_192045_A.func_194303_a(this.width, this.height, this.mc, this.field_192046_B,
		...
		this.field_192048_z = new GuiButtonImage(10, this.guiLeft + 104, this.height / 2 - 22, 20, 18, 178, 0, 19,
	...
	protected boolean isPointInRegion(int rectX, int rectY, int rectWidth, int rectHeight, int pointX, int pointY) {
		return (!this.field_192046_B || !this.field_192045_A.func_191878_b())
	...
	protected boolean func_193983_c(int p_193983_1_, int p_193983_2_, int p_193983_3_, int p_193983_4_) {
		...
		return this.field_192045_A.func_193955_c(p_193983_1_, p_193983_2_, this.guiLeft, this.guiTop, this.xSize,
				this.ySize) && flag;
	}
