...
public class GuiListWorldSelectionEntry implements GuiListExtended.IGuiListEntry {
	...
	public void func_192634_a(int p_192634_1_, int p_192634_2_, int p_192634_3_, int p_192634_4_, int p_192634_5_,
		...
		this.client.fontRendererObj.drawString(s1, p_192634_2_ + 32 + 3,
				p_192634_3_ + this.client.fontRendererObj.FONT_HEIGHT + 3, 8421504);
		this.client.fontRendererObj.drawString(s2, p_192634_2_ + 32 + 3,
				p_192634_3_ + this.client.fontRendererObj.FONT_HEIGHT + this.client.fontRendererObj.FONT_HEIGHT + 3,
				8421504);
		...
		if (this.client.gameSettings.touchscreen || p_192634_8_) {
			...
			if (this.worldSummary.markVersionInList()) {
				Gui.drawModalRectWithCustomSizedTexture(p_192634_2_, p_192634_3_, 32.0F, (float) i, 32, 32, 256.0F,
						256.0F);

				if (this.worldSummary.askToOpenWorld()) {
					Gui.drawModalRectWithCustomSizedTexture(p_192634_2_, p_192634_3_, 96.0F, (float) i, 32, 32, 256.0F,
							256.0F);
					...
					Gui.drawModalRectWithCustomSizedTexture(p_192634_2_, p_192634_3_, 64.0F, (float) i, 32, 32, 256.0F,
							256.0F);
				...
				Gui.drawModalRectWithCustomSizedTexture(p_192634_2_, p_192634_3_, 0.0F, (float) i, 32, 32, 256.0F,
						256.0F);
			}
		}
	}
