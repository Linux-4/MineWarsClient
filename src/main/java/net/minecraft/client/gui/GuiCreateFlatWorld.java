...
public class GuiCreateFlatWorld extends GuiScreen {
	...
	/**
	 * Sets the superflat preset. Invalid or null values will result in the default
	 * superflat preset being used.
	 */
	...
	public void initGui() {
		...
		this.addLayerButton = this.addButton(new GuiButton(2, this.width / 2 - 154, this.height - 52, 100, 20,
				I18n.format("createWorld.customize.flat.addLayer") + " (NYI)"));
		this.editLayerButton = this.addButton(new GuiButton(3, this.width / 2 - 50, this.height - 52, 100, 20,
				I18n.format("createWorld.customize.flat.editLayer") + " (NYI)"));
		this.removeLayerButton = this.addButton(new GuiButton(4, this.width / 2 - 155, this.height - 52, 150, 20,
	...
	/**
	 * Would update whether or not the edit and remove buttons are enabled, but is
	 * currently disabled and always disables the buttons (which are invisible
	 * anyways)
	 */
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		this.drawString(this.fontRendererObj, this.heightText,
				i + 2 + 213 - this.fontRendererObj.getStringWidth(this.heightText), 32, 16777215);
	...
	class Details extends GuiSlot {
		...
		protected void func_192637_a(int p_192637_1_, int p_192637_2_, int p_192637_3_, int p_192637_4_,
			...
			FlatLayerInfo flatlayerinfo = (FlatLayerInfo) GuiCreateFlatWorld.this.theFlatGeneratorInfo.getFlatLayers()
					.get(GuiCreateFlatWorld.this.theFlatGeneratorInfo.getFlatLayers().size() - p_192637_1_ - 1);
			...
			GuiCreateFlatWorld.this.fontRendererObj.drawString(s1,
					p_192637_2_ + 2 + 213 - GuiCreateFlatWorld.this.fontRendererObj.getStringWidth(s1), p_192637_3_ + 3,
					16777215);
		}
