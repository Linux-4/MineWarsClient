...
public class GuiSpectator extends Gui implements ISpectatorMenuRecipient {
	...
	protected void renderPage(ScaledResolution p_175258_1_, float p_175258_2_, int p_175258_3_, float p_175258_4_,
		...
		if (p_175258_5_.getSelectedSlot() >= 0) {
			this.drawTexturedModalRect((float) (p_175258_3_ - 91 - 1 + p_175258_5_.getSelectedSlot() * 20),
		...
		for (int i = 0; i < 9; ++i) {
			this.renderSlot(i, p_175258_1_.getScaledWidth() / 2 - 90 + i * 20 + 2, p_175258_4_ + 3.0F, p_175258_2_,
	...
	private void renderSlot(int p_175266_1_, int p_175266_2_, float p_175266_3_, float p_175266_4_,
		...
		if (p_175266_5_ != SpectatorMenu.EMPTY_SLOT) {
			...
			String s = String.valueOf((Object) GameSettings
					.getKeyDisplayString(this.mc.gameSettings.keyBindsHotbar[p_175266_1_].getKeyCode()));

			if (i > 3 && p_175266_5_.isEnabled()) {
				this.mc.fontRendererObj.drawStringWithShadow(s,
						(float) (p_175266_2_ + 19 - 2 - this.mc.fontRendererObj.getStringWidth(s)),
	...
	public void renderSelectedItem(ScaledResolution p_175263_1_) {
		...
		if (i > 3 && this.menu != null) {
			...
			String s = ispectatormenuobject == SpectatorMenu.EMPTY_SLOT
	...
	public void onMouseScroll(int p_175259_1_) {
		...
		for (i = this.menu.getSelectedSlot() + p_175259_1_; i >= 0 && i <= 8
				&& (this.menu.getItem(i) == SpectatorMenu.EMPTY_SLOT
						|| !this.menu.getItem(i).isEnabled()); i += p_175259_1_) {
			;
		}
