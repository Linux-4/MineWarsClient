...
public class GuiScreenDemo extends GuiScreen {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		this.fontRendererObj.drawString(I18n.format("demo.help.movementShort",
				...
				GameSettings.getKeyDisplayString(gamesettings.keyBindRight.getKeyCode())), i, j, 5197647);
		this.fontRendererObj.drawString(I18n.format("demo.help.movementMouse"), i, j + 12, 5197647);
		this.fontRendererObj.drawString(
				I18n.format("demo.help.jump", GameSettings.getKeyDisplayString(gamesettings.keyBindJump.getKeyCode())),
				i, j + 24, 5197647);
		this.fontRendererObj.drawString(
