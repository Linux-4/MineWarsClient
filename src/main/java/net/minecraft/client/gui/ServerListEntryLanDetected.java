...
public class ServerListEntryLanDetected implements GuiListExtended.IGuiListEntry {
	...
	public void func_192634_a(int p_192634_1_, int p_192634_2_, int p_192634_3_, int p_192634_4_, int p_192634_5_,
		...
		this.mc.fontRendererObj.drawString(I18n.format("lanServer.title"), p_192634_2_ + 32 + 3, p_192634_3_ + 1,
				16777215);
		this.mc.fontRendererObj.drawString(this.serverData.getServerMotd(), p_192634_2_ + 32 + 3, p_192634_3_ + 12,
				8421504);

		if (this.mc.gameSettings.hideServerAddress) {
			this.mc.fontRendererObj.drawString(I18n.format("selectServer.hiddenAddress"), p_192634_2_ + 32 + 3,
					p_192634_3_ + 12 + 11, 3158064);
		} else {
			this.mc.fontRendererObj.drawString(this.serverData.getServerIpPort(), p_192634_2_ + 32 + 3,
					p_192634_3_ + 12 + 11, 3158064);
		}
	}
