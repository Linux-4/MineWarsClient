	...
	public class CategoryEntry implements GuiListExtended.IGuiListEntry {
		...
		public void func_192634_a(int p_192634_1_, int p_192634_2_, int p_192634_3_, int p_192634_4_, int p_192634_5_,
			...
			GuiKeyBindingList.this.mc.fontRendererObj.drawString(this.labelText,
					...
					p_192634_3_ + p_192634_5_ - GuiKeyBindingList.this.mc.fontRendererObj.FONT_HEIGHT - 1, 16777215);
		}
	...
	public class KeyEntry implements GuiListExtended.IGuiListEntry {
		...
		public void func_192634_a(int p_192634_1_, int p_192634_2_, int p_192634_3_, int p_192634_4_, int p_192634_5_,
			...
			GuiKeyBindingList.this.mc.fontRendererObj.drawString(this.keyDesc,
					p_192634_2_ + 90 - GuiKeyBindingList.this.maxListLabelWidth,
					p_192634_3_ + p_192634_5_ / 2 - GuiKeyBindingList.this.mc.fontRendererObj.FONT_HEIGHT / 2,
					16777215);
