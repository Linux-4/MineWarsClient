...
public class GuiOptionsRowList extends GuiListExtended {
	...
	private GuiButton createButton(Minecraft mcIn, int p_148182_2_, int p_148182_3_, GameSettings.Options options) {
		if (options == null) {
			...
			return (GuiButton) (options.getEnumFloat() ? new GuiOptionSlider(i, p_148182_2_, p_148182_3_, options)
					: new GuiOptionButton(i, p_148182_2_, p_148182_3_, options,
							mcIn.gameSettings.getKeyBinding(options)));
		}
	}
			...
			if (this.buttonA.mousePressed(this.client, mouseX, mouseY)) {
				if (this.buttonA instanceof GuiOptionButton) {
					...
					this.buttonA.displayString = this.client.gameSettings
							.getKeyBinding(GameSettings.Options.getEnumOptions(this.buttonA.id));
				}
				...
				if (this.buttonB instanceof GuiOptionButton) {
					...
					this.buttonB.displayString = this.client.gameSettings
							.getKeyBinding(GameSettings.Options.getEnumOptions(this.buttonB.id));
				}
