...
public class GuiVideoSettings extends GuiScreenOF {
	...
	private static GameSettings.Options[] videoOptions = new GameSettings.Options[] { GameSettings.Options.GRAPHICS,
			...
			GameSettings.Options.ATTACK_INDICATOR, GameSettings.Options.DYNAMIC_LIGHTS,
	...
	private void actionPerformed(GuiButton p_actionPerformed_1_, int p_actionPerformed_2_) {
		if (p_actionPerformed_1_.enabled) {
			...
			if (p_actionPerformed_1_.id < 200 && p_actionPerformed_1_ instanceof GuiOptionButton) {
				this.guiGameSettings.setOptionValue(((GuiOptionButton) p_actionPerformed_1_).returnEnumOptions(),
						p_actionPerformed_2_);
				p_actionPerformed_1_.displayString = this.guiGameSettings
						.getKeyBinding(GameSettings.Options.getEnumOptions(p_actionPerformed_1_.id));
			}
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		String s2 = MineWarsClient.NAME + " " + MineWarsClient.VERSION;
