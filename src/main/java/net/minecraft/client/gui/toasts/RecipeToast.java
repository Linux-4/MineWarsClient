...
public class RecipeToast implements IToast {
	...
	public IToast.Visibility func_193653_a(GuiToast p_193653_1_, long p_193653_2_) {
		...
		if (this.field_193666_c.isEmpty()) {
			...
			p_193653_1_.func_192989_b().fontRendererObj.drawString(I18n.format("recipe.toast.description"), 30, 18,
					-16777216);
			RenderHelper.enableGUIStandardItemLighting();
			p_193653_1_.func_192989_b().getRenderItem()
					.renderItemAndEffectIntoGUI(
							(EntityLivingBase) null, this.field_193666_c.get((int) (p_193653_2_
									/ (5000L / (long) this.field_193666_c.size()) % (long) this.field_193666_c.size())),
							8, 8);
