...
public class AdvancementToast implements IToast {
	...
	public IToast.Visibility func_193653_a(GuiToast p_193653_1_, long p_193653_2_) {
		...
		if (displayinfo != null) {
			List<String> list = p_193653_1_.func_192989_b().fontRendererObj
					.listFormattedStringToWidth(displayinfo.func_192297_a().getFormattedText(), 125);
			int i = displayinfo.func_192291_d() == FrameType.CHALLENGE ? 16746751 : 16776960;

			if (list.size() == 1) {
				p_193653_1_.func_192989_b().fontRendererObj.drawString(
						I18n.format("advancements.toast." + displayinfo.func_192291_d().func_192307_a()), 30, 7,
						i | -16777216);
				p_193653_1_.func_192989_b().fontRendererObj.drawString(displayinfo.func_192297_a().getFormattedText(),
						30, 18, -1);
			} else {
				int j = 1500;
				float f = 300.0F;
				...
				if (p_193653_2_ < 1500L) {
					int k = MathHelper
							.floor(MathHelper.clamp((float) (1500L - p_193653_2_) / 300.0F, 0.0F, 1.0F) * 255.0F) << 24
							| 67108864;
					p_193653_1_.func_192989_b().fontRendererObj.drawString(
							I18n.format("advancements.toast." + displayinfo.func_192291_d().func_192307_a()), 30, 11,
							i | k);
				} else {
					int i1 = MathHelper
							.floor(MathHelper.clamp((float) (p_193653_2_ - 1500L) / 300.0F, 0.0F, 1.0F) * 252.0F) << 24
							| 67108864;
			...
			if (!this.field_194168_d && p_193653_2_ > 0L) {
				...
				if (displayinfo.func_192291_d() == FrameType.CHALLENGE) {
					p_193653_1_.func_192989_b().getSoundHandler()
							.playSound(PositionedSoundRecord.func_194007_a(SoundEvents.field_194228_if, 1.0F, 1.0F));
				}
			}

			RenderHelper.enableGUIStandardItemLighting();
			p_193653_1_.func_192989_b().getRenderItem().renderItemAndEffectIntoGUI((EntityLivingBase) null,
					displayinfo.func_192298_b(), 8, 8);
