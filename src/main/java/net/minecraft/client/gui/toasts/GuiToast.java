...
public class GuiToast extends Gui {
	...
	public <T extends IToast> T func_192990_a(Class<? extends T> p_192990_1_, Object p_192990_2_) {
		for (GuiToast.ToastInstance<?> toastinstance : this.field_191791_g) {
			if (toastinstance != null && p_192990_1_.isAssignableFrom(toastinstance.func_193685_a().getClass())
					&& toastinstance.func_193685_a().func_193652_b().equals(p_192990_2_)) {
	...
	class ToastInstance<T extends IToast> {
		...
		public boolean func_193684_a(int p_193684_1_, int p_193684_2_) {
			...
			GlStateManager.translate((float) p_193684_1_ - 160.0F * this.func_193686_a(i), (float) (p_193684_2_ * 32),
					(float) (500 + p_193684_2_));
			IToast.Visibility itoast$visibility = this.field_193688_b.func_193653_a(GuiToast.this,
					i - this.field_193690_d);
