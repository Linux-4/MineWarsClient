...
public class TutorialToast implements IToast {
	...
	public TutorialToast(TutorialToast.Icons p_i47487_1_, ITextComponent p_i47487_2_,
			@Nullable ITextComponent p_i47487_3_, boolean p_i47487_4_) {
	...
	public IToast.Visibility func_193653_a(GuiToast p_193653_1_, long p_193653_2_) {
		...
		if (this.field_193678_j) {
			...
			float f = (float) MathHelper.clampedLerp((double) this.field_193676_h, (double) this.field_193677_i,
					(double) ((float) (p_193653_2_ - this.field_193675_g) / 100.0F));
			int i;
	...
	public static enum Icons {
		MOVEMENT_KEYS(0, 0), MOUSE(1, 0), TREE(2, 0), RECIPE_BOOK(0, 1), WOODEN_PLANKS(1, 1);
		...
		public void func_193697_a(Gui p_193697_1_, int p_193697_2_, int p_193697_3_) {
			...
			p_193697_1_.drawTexturedModalRect(p_193697_2_, p_193697_3_, 176 + this.field_193703_f * 20,
					this.field_193704_g * 20, 20, 20);
			GlStateManager.enableBlend();
		}
	}
}
