...
public class GuiAdvancement extends Gui {
	private static final ResourceLocation field_191827_a = new ResourceLocation(
	...
	public GuiAdvancement(GuiAdvancementTab p_i47385_1_, Minecraft p_i47385_2_, Advancement p_i47385_3_,
		...
		this.field_191831_i = p_i47385_2_.fontRendererObj
				.trimStringToWidth(p_i47385_4_.func_192297_a().getFormattedText(), 163);
		...
		int k = i > 1
				? p_i47385_2_.fontRendererObj.getStringWidth("  ")
						+ p_i47385_2_.fontRendererObj.getStringWidth("0") * j * 2
						+ p_i47385_2_.fontRendererObj.getStringWidth("/")
				: 0;
	...
	private List<String> func_192995_a(String p_192995_1_, int p_192995_2_) {
		if (p_192995_1_.isEmpty()) {
			...
			List<String> list = this.field_191833_k.fontRendererObj.listFormattedStringToWidth(p_192995_1_,
					p_192995_2_);
	...
	public void func_191817_b(int p_191817_1_, int p_191817_2_) {
		if (!this.field_191830_h.func_193224_j()
				|| this.field_191836_n != null && this.field_191836_n.func_192105_a()) {
			...
			this.drawTexturedModalRect(p_191817_1_ + this.field_191837_o + 3, p_191817_2_ + this.field_191826_p,
					this.field_191830_h.func_192291_d().func_192309_b(), 128 + advancementstate.func_192667_a() * 26,
					26, 26);
			RenderHelper.enableGUIStandardItemLighting();
			this.field_191833_k.getRenderItem().renderItemAndEffectIntoGUI((EntityLivingBase) null,
					this.field_191830_h.func_192298_b(), p_191817_1_ + this.field_191837_o + 8,
					p_191817_2_ + this.field_191826_p + 5);
		}
	...
	public void func_191821_a(int p_191821_1_, int p_191821_2_, float p_191821_3_, int p_191821_4_, int p_191821_5_) {
		boolean flag = p_191821_4_ + p_191821_1_ + this.field_191837_o + this.field_191832_j
				+ 26 >= this.field_191828_f.func_193934_g().width;
		...
		boolean flag1 = 113 - p_191821_2_ - this.field_191826_p - 26 <= 6
				+ this.field_192997_l.size() * this.field_191833_k.fontRendererObj.FONT_HEIGHT;
		float f = this.field_191836_n == null ? 0.0F : this.field_191836_n.func_192103_c();
		...
		this.drawTexturedModalRect(p_191821_1_ + this.field_191837_o + 3, p_191821_2_ + this.field_191826_p,
				this.field_191830_h.func_192291_d().func_192309_b(), 128 + advancementstate2.func_192667_a() * 26, 26,
				26);

		if (flag) {
			this.field_191833_k.fontRendererObj.drawString(this.field_191831_i, (float) (i1 + 5),
					(float) (p_191821_2_ + this.field_191826_p + 9), -1, true);

			if (s != null) {
				this.field_191833_k.fontRendererObj.drawString(s, (float) (p_191821_1_ + this.field_191837_o - i),
						(float) (p_191821_2_ + this.field_191826_p + 9), -1, true);
			}
		} else {
			this.field_191833_k.fontRendererObj.drawString(this.field_191831_i,
					(float) (p_191821_1_ + this.field_191837_o + 32), (float) (p_191821_2_ + this.field_191826_p + 9),
					-1, true);

			if (s != null) {
				this.field_191833_k.fontRendererObj.drawString(s,
						(float) (p_191821_1_ + this.field_191837_o + this.field_191832_j - i - 5),
						(float) (p_191821_2_ + this.field_191826_p + 9), -1, true);
			}
		}
		...
		if (flag1) {
			for (int k1 = 0; k1 < this.field_192997_l.size(); ++k1) {
				this.field_191833_k.fontRendererObj.drawString(this.field_192997_l.get(k1), (float) (i1 + 5),
						(float) (l + 26 - j1 + 7 + k1 * this.field_191833_k.fontRendererObj.FONT_HEIGHT), -5592406,
						false);
			}
		} else {
			for (int l1 = 0; l1 < this.field_192997_l.size(); ++l1) {
				this.field_191833_k.fontRendererObj.drawString(this.field_192997_l.get(l1), (float) (i1 + 5),
						(float) (p_191821_2_ + this.field_191826_p + 9 + 17
								+ l1 * this.field_191833_k.fontRendererObj.FONT_HEIGHT),
						-5592406, false);
			}
		}
		...
		RenderHelper.enableGUIStandardItemLighting();
		this.field_191833_k.getRenderItem().renderItemAndEffectIntoGUI((EntityLivingBase) null,
				this.field_191830_h.func_192298_b(), p_191821_1_ + this.field_191837_o + 8,
				p_191821_2_ + this.field_191826_p + 5);
	}

	protected void func_192994_a(int p_192994_1_, int p_192994_2_, int p_192994_3_, int p_192994_4_, int p_192994_5_,
		...
		this.func_192993_a(p_192994_1_ + p_192994_5_, p_192994_2_, p_192994_3_ - p_192994_5_ - p_192994_5_, p_192994_5_,
				p_192994_8_ + p_192994_5_, p_192994_9_, p_192994_6_ - p_192994_5_ - p_192994_5_, p_192994_7_);
		...
		this.func_192993_a(p_192994_1_ + p_192994_5_, p_192994_2_ + p_192994_4_ - p_192994_5_,
		...
		this.drawTexturedModalRect(p_192994_1_ + p_192994_3_ - p_192994_5_, p_192994_2_ + p_192994_4_ - p_192994_5_,
				...
				p_192994_5_);
		this.func_192993_a(p_192994_1_, p_192994_2_ + p_192994_5_, p_192994_5_, p_192994_4_ - p_192994_5_ - p_192994_5_,
				p_192994_8_, p_192994_9_ + p_192994_5_, p_192994_6_, p_192994_7_ - p_192994_5_ - p_192994_5_);
		this.func_192993_a(p_192994_1_ + p_192994_5_, p_192994_2_ + p_192994_5_,
		...
		this.func_192993_a(p_192994_1_ + p_192994_3_ - p_192994_5_, p_192994_2_ + p_192994_5_, p_192994_5_,
	...
	protected void func_192993_a(int p_192993_1_, int p_192993_2_, int p_192993_3_, int p_192993_4_, int p_192993_5_,
