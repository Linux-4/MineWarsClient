...
public class GuiScreenAdvancements extends GuiScreen implements ClientAdvancementManager.IListener {
	...
	private final Map<Advancement, GuiAdvancementTab> field_191947_i = Maps
			.<Advancement, GuiAdvancementTab>newLinkedHashMap();
	...
	public void initGui() {
		...
		if (this.field_191940_s == null && !this.field_191947_i.isEmpty()) {
			this.field_191946_h.func_194230_a(
					((GuiAdvancementTab) this.field_191947_i.values().iterator().next()).func_193935_c(), true);
		} else {
			this.field_191946_h.func_194230_a(this.field_191940_s == null ? null : this.field_191940_s.func_193935_c(),
					true);
		}
	}
	...
	private void func_191936_c(int p_191936_1_, int p_191936_2_, int p_191936_3_, int p_191936_4_) {
		...
		if (guiadvancementtab == null) {
			...
			this.fontRendererObj.drawString(s, p_191936_3_ + 9 + 117 - i / 2,
					p_191936_4_ + 18 + 56 - this.fontRendererObj.FONT_HEIGHT / 2, -1);
			this.fontRendererObj.drawString(":(", p_191936_3_ + 9 + 117 - this.fontRendererObj.getStringWidth(":(") / 2,
					p_191936_4_ + 18 + 113 - this.fontRendererObj.FONT_HEIGHT, -1);
		} else {
	...
	private void func_191937_d(int p_191937_1_, int p_191937_2_, int p_191937_3_, int p_191937_4_) {
		...
		if (this.field_191940_s != null) {
			...
			this.field_191940_s.func_192991_a(p_191937_1_ - p_191937_3_ - 9, p_191937_2_ - p_191937_4_ - 18,
					p_191937_3_, p_191937_4_);
			GlStateManager.disableDepth();
			GlStateManager.popMatrix();
		}
	...
	public void func_191931_a(Advancement p_191931_1_) {
		GuiAdvancementTab guiadvancementtab = GuiAdvancementTab.func_193936_a(this.mc, this, this.field_191947_i.size(),
				p_191931_1_);
