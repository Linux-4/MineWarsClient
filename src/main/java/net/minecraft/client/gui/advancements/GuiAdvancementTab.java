...
public class GuiAdvancementTab extends Gui {
	...
	private final Map<Advancement, GuiAdvancement> field_191810_m = Maps
			.<Advancement, GuiAdvancement>newLinkedHashMap();
	...
	public void func_191796_a(int p_191796_1_, int p_191796_2_, RenderItem p_191796_3_) {
		this.field_191803_f.func_192652_a(p_191796_1_, p_191796_2_, this.field_191804_g, p_191796_3_,
				this.field_191807_j);
	}
		...
		if (p_192991_1_ > 0 && p_192991_1_ < 234 && p_192991_2_ > 0 && p_192991_2_ < 113) {
			for (GuiAdvancement guiadvancement : this.field_191810_m.values()) {
				if (guiadvancement.func_191816_c(this.field_191811_n, this.field_191812_o, p_192991_1_, p_192991_2_)) {
					flag = true;
					guiadvancement.func_191821_a(this.field_191811_n, this.field_191812_o, this.field_191815_r,
							p_192991_3_, p_192991_4_);
					break;
				}
			}
		}
	...
	public boolean func_191793_c(int p_191793_1_, int p_191793_2_, int p_191793_3_, int p_191793_4_) {
		return this.field_191803_f.func_192654_a(p_191793_1_, p_191793_2_, this.field_191804_g, p_191793_3_,
				p_191793_4_);
	}

	@Nullable
	public static GuiAdvancementTab func_193936_a(Minecraft p_193936_0_, GuiScreenAdvancements p_193936_1_,
			int p_193936_2_, Advancement p_193936_3_) {
		if (p_193936_3_.func_192068_c() == null) {
			return null;
		} else {
			for (AdvancementTabType advancementtabtype : AdvancementTabType.values()) {
				if (p_193936_2_ < advancementtabtype.func_192650_a()) {
					return new GuiAdvancementTab(p_193936_0_, p_193936_1_, advancementtabtype, p_193936_2_, p_193936_3_,
							p_193936_3_.func_192068_c());
				}
	...
	public void func_191800_a(Advancement p_191800_1_) {
		if (p_191800_1_.func_192068_c() != null) {
			GuiAdvancement guiadvancement = new GuiAdvancement(this, this.field_191802_a, p_191800_1_,
					p_191800_1_.func_192068_c());
