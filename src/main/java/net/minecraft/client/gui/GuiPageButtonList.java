...
public class GuiPageButtonList extends GuiListExtended {
	...
	private void populateComponents() {
		for (GuiPageButtonList.GuiListEntry[] aguipagebuttonlist$guilistentry : this.pages) {
			for (int i = 0; i < aguipagebuttonlist$guilistentry.length; i += 2) {
				...
				Gui gui1 = this.createEntry(guipagebuttonlist$guilistentry1, 160,
	...
	private Gui createEntry(@Nullable GuiPageButtonList.GuiListEntry p_178058_1_, int p_178058_2_,
		...
		if (p_178058_1_ instanceof GuiPageButtonList.GuiSlideEntry) {
			return this.createSlider(this.width / 2 - 155 + p_178058_2_, 0,
					(GuiPageButtonList.GuiSlideEntry) p_178058_1_);
		} else if (p_178058_1_ instanceof GuiPageButtonList.GuiButtonEntry) {
			return this.createButton(this.width / 2 - 155 + p_178058_2_, 0,
					(GuiPageButtonList.GuiButtonEntry) p_178058_1_);
		} else if (p_178058_1_ instanceof GuiPageButtonList.EditBoxEntry) {
			return this.createTextField(this.width / 2 - 155 + p_178058_2_, 0,
					(GuiPageButtonList.EditBoxEntry) p_178058_1_);
		} else {
			return p_178058_1_ instanceof GuiPageButtonList.GuiLabelEntry
					? this.createLabel(this.width / 2 - 155 + p_178058_2_, 0,
	...
	private GuiSlider createSlider(int p_178067_1_, int p_178067_2_, GuiPageButtonList.GuiSlideEntry p_178067_3_) {
		GuiSlider guislider = new GuiSlider(this.responder, p_178067_3_.getId(), p_178067_1_, p_178067_2_,
				p_178067_3_.getCaption(), p_178067_3_.getMinValue(), p_178067_3_.getMaxValue(),
	...
	private GuiListButton createButton(int p_178065_1_, int p_178065_2_, GuiPageButtonList.GuiButtonEntry p_178065_3_) {
		GuiListButton guilistbutton = new GuiListButton(this.responder, p_178065_3_.getId(), p_178065_1_, p_178065_2_,
				p_178065_3_.getCaption(), p_178065_3_.getInitialValue());
	...
	private GuiTextField createTextField(int p_178068_1_, int p_178068_2_, GuiPageButtonList.EditBoxEntry p_178068_3_) {
		GuiTextField guitextfield = new GuiTextField(p_178068_3_.getId(), this.mc.fontRendererObj, p_178068_1_,
				p_178068_2_, 150, 20);
	...
	private GuiLabel createLabel(int p_178063_1_, int p_178063_2_, GuiPageButtonList.GuiLabelEntry p_178063_3_,
		...
		if (p_178063_4_) {
			guilabel = new GuiLabel(this.mc.fontRendererObj, p_178063_3_.getId(), p_178063_1_, p_178063_2_,
					this.width - p_178063_1_ * 2, 20, -1);
		} else {
			guilabel = new GuiLabel(this.mc.fontRendererObj, p_178063_3_.getId(), p_178063_1_, p_178063_2_, 150, 20,
					-1);
		}
	...
	public static class GuiEntry implements GuiListExtended.IGuiListEntry {
		...
		private void func_192636_a(Gui p_192636_1_, int p_192636_2_, int p_192636_3_, int p_192636_4_,
				boolean p_192636_5_, float p_192636_6_) {
			if (p_192636_1_ != null) {
				if (p_192636_1_ instanceof GuiButton) {
					this.func_192635_a((GuiButton) p_192636_1_, p_192636_2_, p_192636_3_, p_192636_4_, p_192636_5_,
							p_192636_6_);
		...
		private void func_192635_a(GuiButton p_192635_1_, int p_192635_2_, int p_192635_3_, int p_192635_4_,
