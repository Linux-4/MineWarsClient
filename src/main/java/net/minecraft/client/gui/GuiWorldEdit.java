...
public class GuiWorldEdit extends GuiScreen {
	...
	public void initGui() {
		...
		GuiButton guibutton = this.addButton(new GuiButton(3, this.width / 2 - 100, this.height / 4 + 24 + 12,
				I18n.format("selectWorld.edit.resetIcon")));
		this.buttonList.add(new GuiButton(4, this.width / 2 - 100, this.height / 4 + 48 + 12,
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		this.drawCenteredString(this.fontRendererObj, I18n.format("selectWorld.edit.title"), this.width / 2, 20,
				16777215);
