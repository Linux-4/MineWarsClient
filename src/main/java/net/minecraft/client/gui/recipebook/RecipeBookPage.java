...
public class RecipeBookPage {
	...
	public void func_194194_a(Minecraft p_194194_1_, int p_194194_2_, int p_194194_3_) {
		...
		for (int i = 0; i < this.field_193743_h.size(); ++i) {
			((GuiButtonRecipe) this.field_193743_h.get(i)).func_191770_c(p_194194_2_ + 11 + 25 * (i % 5),
					p_194194_3_ + 31 + 25 * (i / 5));
		}
	...
	public void func_193721_a(int p_193721_1_, int p_193721_2_) {
		if (this.field_193754_s.currentScreen != null && this.field_194201_b != null
				&& !this.field_194202_c.func_191839_a()) {
			this.field_193754_s.currentScreen.drawHoveringText(
					this.field_194201_b.func_191772_a(this.field_193754_s.currentScreen), p_193721_1_, p_193721_2_);
		}
	}
	...
	public boolean func_194196_a(int p_194196_1_, int p_194196_2_, int p_194196_3_, int p_194196_4_, int p_194196_5_,
		...
		if (this.field_194202_c.func_191839_a()) {
			...
			return true;
		} else if (this.field_193740_e.mousePressed(this.field_193754_s, p_194196_1_, p_194196_2_)
				&& p_194196_3_ == 0) {
			this.field_193740_e.playPressSound(this.field_193754_s.getSoundHandler());
			++this.field_193738_c;
			this.func_194198_d();
			return true;
		} else if (this.field_193741_f.mousePressed(this.field_193754_s, p_194196_1_, p_194196_2_)
				&& p_194196_3_ == 0) {
			...
			for (GuiButtonRecipe guibuttonrecipe : this.field_193743_h) {
				if (guibuttonrecipe.mousePressed(this.field_193754_s, p_194196_1_, p_194196_2_)) {
					...
					if (p_194196_3_ == 0) {
						...
						this.field_194202_c.func_191845_a(this.field_193754_s, guibuttonrecipe.func_191771_c(),
								guibuttonrecipe.xPosition, guibuttonrecipe.yPosition, p_194196_4_ + p_194196_6_ / 2,
								p_194196_5_ + 13 + p_194196_7_ / 2, (float) guibuttonrecipe.getButtonWidth(),
								this.field_194204_k);
					}
