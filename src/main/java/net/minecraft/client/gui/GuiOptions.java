...
public class GuiOptions extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        {
            this.buttonList.add(new GuiButton(300, this.width / 2 - 155 + i % 2 * 160, this.height / 6 - 12 + 24 * (i >> 1), 150, 20, "Nicht verfügbar!"));
        }
        ...
        this.buttonList.add(new GuiButton(104, this.width / 2 + 5, this.height / 6 + 120 - 6, 150, 20, I18n.format("Nicht verfügbar!")));
