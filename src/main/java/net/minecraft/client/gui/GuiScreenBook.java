		...
		if (this.bookGettingSigned) {
				...
				if (ItemWrittenBook.validBookTagContents(this.bookObj.getTagCompound())) {
					try {
						...
						this.cachedComponents = itextcomponent != null
								? GuiUtilRenderComponents.splitText(itextcomponent, 116, this.fontRendererObj, true,
										true)
								: null;
			...
			if (this.cachedComponents == null) {
				...
				for (int l1 = 0; l1 < k1; ++l1) {
					...
					this.fontRendererObj.drawString(itextcomponent2.getUnformattedText(), i + 36,
							34 + l1 * this.fontRendererObj.FONT_HEIGHT, 0);
				}
