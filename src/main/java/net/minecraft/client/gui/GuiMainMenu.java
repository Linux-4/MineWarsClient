...
public class GuiMainMenu extends GuiScreen {
	...
	private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_) {
		...
		if (Reflector.GuiModList_Constructor.exists()) {
			this.realmsButton = this.addButton(new GuiButton(14, this.width / 2 + 2, p_73969_1_ + p_73969_2_ * 2, 98,
			...
			this.realmsButton = this.addButton(
					new GuiButton(14, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2, I18n.format("MineWars.eu")));
		}
	}
	...
	protected void actionPerformed(GuiButton button) throws IOException {
		...
		if (button.id == 14 && this.realmsButton.visible) {
			this.mc.displayGuiScreen(new GuiConnecting(this, Minecraft.getMinecraft(),
					new ServerData("MineWars.eu", "MineWars.eu", false)));
		}
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		if (Reflector.ForgeHooksClient_renderMainMenu.exists()) {
			this.splashText = Reflector.callString(Reflector.ForgeHooksClient_renderMainMenu, this,
					this.fontRendererObj, this.width, this.height, this.splashText);
		}
		...
		GlStateManager.popMatrix();
		String s = MineWarsClient.NAME + " " + MineWarsClient.VERSION;
		...
		if (Reflector.FMLCommonHandler_getBrandings.exists()) {
			...
			List<String> list = Lists
					.<String>reverse((List) Reflector.call(object, Reflector.FMLCommonHandler_getBrandings, true));
		...
		this.drawString(this.fontRendererObj, "Copyright Mojang AB. Do not distribute!", this.field_193979_N,
				this.height - 10, -1);
