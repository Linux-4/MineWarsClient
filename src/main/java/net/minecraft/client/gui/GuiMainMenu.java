...
public class GuiMainMenu extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.field_193978_M = this.fontRendererObj.getStringWidth("MineWars.eu");
    ...
    private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_)
    {
        ...
        {
            this.realmsButton = this.addButton(new GuiButton(14, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2, I18n.format("MineWars.eu")));
        }
    }
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        ...
        {
           this.mc.displayGuiScreen(new GuiConnecting(this, Minecraft.getMinecraft(), new ServerData("MineWars.eu", "MineWars.eu", false)));
        }
