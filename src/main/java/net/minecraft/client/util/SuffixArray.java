...
public class SuffixArray<T> {
	private static final boolean field_194062_b = Boolean
			.parseBoolean(System.getProperty("SuffixArray.printComparisons", "false"));
	private static final boolean field_194063_c = Boolean
	...
	public List<T> func_194055_a(String p_194055_1_) {
		...
		while (j2 < k2) {
			...
			if (field_194062_b) {
				field_194064_d.debug("comparing lower \"{}\" with {} \"{}\": {}", p_194055_1_, Integer.valueOf(l2),
						this.func_194059_a(l2), Integer.valueOf(i3));
			}
		...
		if (j2 >= 0 && j2 < i2) {
			...
			while (j2 < k2) {
				...
				if (field_194062_b) {
					field_194064_d.debug("comparing upper \"{}\" with {} \"{}\": {}", p_194055_1_, Integer.valueOf(j4),
							this.func_194059_a(j4), Integer.valueOf(j3));
				}
