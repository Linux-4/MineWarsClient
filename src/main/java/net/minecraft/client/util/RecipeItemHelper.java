...
public class RecipeItemHelper {
	...
	public void func_194112_a(ItemStack p_194112_1_) {
		if (!p_194112_1_.func_190926_b() && !p_194112_1_.isItemDamaged() && !p_194112_1_.isItemEnchanted()
				&& !p_194112_1_.hasDisplayName()) {
	...
	public static ItemStack func_194115_b(int p_194115_0_) {
		return p_194115_0_ == 0 ? ItemStack.field_190927_a
	...
	class RecipePicker {
		...
		public RecipePicker(IRecipe p_i47608_2_) {
			...
			this.field_194110_g = new BitSet(this.field_194107_d + this.field_194109_f + this.field_194107_d
					+ this.field_194107_d * this.field_194109_f);
			...
			if (p_194092_1_ <= 0) {
				...
				for (k = 0; this.func_194098_a(p_194092_1_); ++k) {
					...
					for (int i1 = 0; i1 < l; ++i1) {
						this.func_194089_c((i1 & 1) == 0, ((Integer) this.field_194111_h.get(i1)).intValue(),
								((Integer) this.field_194111_h.get(i1 + 1)).intValue());
					}
				...
				if (RecipeItemHelper.this.field_194124_a.get(this.field_194108_e[l]) >= p_194098_1_) {
					...
					while (!this.field_194111_h.isEmpty()) {
						...
						for (int l1 = 0; l1 < k1; ++l1) {
							if (!this.func_194101_b(flag, l1) && this.func_194093_a(flag, j1, l1)
									&& this.func_194100_b(flag, j1, l1)) {
		...
		private boolean func_194100_b(boolean p_194100_1_, int p_194100_2_, int p_194100_3_) {
			return p_194100_1_ != this.field_194110_g
					.get(1 + this.func_194095_d(p_194100_1_, p_194100_2_, p_194100_3_));
		}
		...
		private int func_194095_d(boolean p_194095_1_, int p_194095_2_, int p_194095_3_) {
			int k = p_194095_1_ ? p_194095_2_ * this.field_194107_d + p_194095_3_
					: p_194095_3_ * this.field_194107_d + p_194095_2_;
		...
		private int func_194090_b() {
			...
			for (Ingredient ingredient : this.field_194106_c) {
				...
				for (IntListIterator intlistiterator = ingredient.func_194139_b().iterator(); intlistiterator
						.hasNext(); l = Math.max(l, RecipeItemHelper.this.field_194124_a.get(i1))) {
