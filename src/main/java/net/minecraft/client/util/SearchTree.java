	...
	public List<T> func_194038_a(String p_194038_1_) {
		...
		if (p_194038_1_.indexOf(58) < 0) {
			...
			return (List<T>) (list1.isEmpty() ? list
					: Lists.newArrayList(
							new SearchTree.MergingIterator(list.iterator(), list1.iterator(), this.field_194049_f)));
		}
	}
		...
		protected T computeNext() {
			if (this.field_194036_d == null && this.field_194037_e == null) {
				...
				if (this.field_194036_d == this.field_194037_e) {
					...
					i = Integer.compare(this.field_194035_c.getInt(this.field_194036_d),
							this.field_194035_c.getInt(this.field_194037_e));
				}
