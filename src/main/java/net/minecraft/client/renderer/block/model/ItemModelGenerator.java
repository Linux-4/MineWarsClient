...
public class ItemModelGenerator {
	...
	public ModelBlock makeItemModel(TextureMap textureMapIn, ModelBlock blockModel) {
		...
		if (list.isEmpty()) {
			...
			return new ModelBlock((ResourceLocation) null, list, map, false, false, blockModel.getAllTransforms(),
	...
	private List<BlockPart> getBlockParts(int tintIndex, String p_178394_2_, TextureAtlasSprite p_178394_3_) {
		...
		map.put(EnumFacing.SOUTH, new BlockPartFace((EnumFacing) null, tintIndex, p_178394_2_,
				new BlockFaceUV(new float[] { 0.0F, 0.0F, 16.0F, 16.0F }, 0)));
		map.put(EnumFacing.NORTH, new BlockPartFace((EnumFacing) null, tintIndex, p_178394_2_,
	...
	private void checkTransition(ItemModelGenerator.SpanFacing p_178396_1_, List<ItemModelGenerator.Span> p_178396_2_,
			...
			boolean p_178396_8_) {
		boolean flag = this.isTransparent(p_178396_3_, p_178396_4_ + p_178396_1_.getXOffset(),
				p_178396_5_ + p_178396_1_.getYOffset(), p_178396_6_, p_178396_7_) && p_178396_8_;
