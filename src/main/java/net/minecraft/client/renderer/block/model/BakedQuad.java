...
public class BakedQuad implements IVertexProducer {
	/**
	 * Joined 4 vertex records, each stores packed data according to the
	 * VertexFormat of the quad. Vanilla minecraft uses DefaultVertexFormats.BLOCK,
	 * Forge uses (usually) ITEM, use BakedQuad.getFormat() to get the correct
	 * format.
	 */
	...
	public BakedQuad(int[] p_i6_1_, int p_i6_2_, EnumFacing p_i6_3_, TextureAtlasSprite p_i6_4_, boolean p_i6_5_,
			VertexFormat p_i6_6_) {
