...
public class ModelBakery {
	...
	private void loadVariantItemModels() {
		this.variants.put(MODEL_MISSING, new VariantList(Lists.newArrayList(
				new Variant(new ResourceLocation(MODEL_MISSING.getResourcePath()), ModelRotation.X0_Y0, false, 1))));
		this.func_191401_d();
	...
	private void registerVariantNames() {
		...
		this.variantNames.put(Item.getItemFromBlock(Blocks.field_192443_dR),
