...
public class TileEntityEndGatewayRenderer extends TileEntityEndPortalRenderer {
	...
	public void func_192841_a(TileEntityEndPortal p_192841_1_, double p_192841_2_, double p_192841_4_,
		...
		if (tileentityendgateway.isSpawning() || tileentityendgateway.isCoolingDown()) {
			...
			float f = tileentityendgateway.isSpawning() ? tileentityendgateway.getSpawnPercent(p_192841_8_)
					: tileentityendgateway.getCooldownPercent(p_192841_8_);
			...
			float[] afloat = tileentityendgateway.isSpawning() ? EnumDyeColor.MAGENTA.func_193349_f()
					: EnumDyeColor.PURPLE.func_193349_f();
			TileEntityBeaconRenderer.renderBeamSegment(p_192841_2_, p_192841_4_, p_192841_6_, (double) p_192841_8_,
					(double) f, (double) tileentityendgateway.getWorld().getTotalWorldTime(), 0, i, afloat, 0.15D,
					0.175D);
			TileEntityBeaconRenderer.renderBeamSegment(p_192841_2_, p_192841_4_, p_192841_6_, (double) p_192841_8_,
					(double) f, (double) tileentityendgateway.getWorld().getTotalWorldTime(), 0, -i, afloat, 0.15D,
					0.175D);
