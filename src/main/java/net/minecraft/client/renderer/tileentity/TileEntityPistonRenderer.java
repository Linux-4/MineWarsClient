...
public class TileEntityPistonRenderer extends TileEntitySpecialRenderer<TileEntityPiston> {
	...
	public void func_192841_a(TileEntityPiston p_192841_1_, double p_192841_2_, double p_192841_4_, double p_192841_6_,
		...
		if (iblockstate.getMaterial() != Material.AIR && p_192841_1_.getProgress(p_192841_8_) < 1.0F) {
			...
			bufferbuilder.setTranslation(
					p_192841_2_ - (double) blockpos.getX() + (double) p_192841_1_.getOffsetX(p_192841_8_),
					p_192841_4_ - (double) blockpos.getY() + (double) p_192841_1_.getOffsetY(p_192841_8_),
					p_192841_6_ - (double) blockpos.getZ() + (double) p_192841_1_.getOffsetZ(p_192841_8_));
			...
			if (block == Blocks.PISTON_HEAD && p_192841_1_.getProgress(p_192841_8_) <= 0.25F) {
				...
				iblockstate1 = iblockstate1.withProperty(BlockPistonExtension.SHORT,
						Boolean.valueOf(p_192841_1_.getProgress(p_192841_8_) >= 0.5F));
				this.renderStateModel(blockpos, iblockstate1, bufferbuilder, world, true);
				bufferbuilder.setTranslation(p_192841_2_ - (double) blockpos.getX(),
						p_192841_4_ - (double) blockpos.getY(), p_192841_6_ - (double) blockpos.getZ());
	...
	private boolean renderStateModel(BlockPos p_188186_1_, IBlockState p_188186_2_, BufferBuilder p_188186_3_,
			World p_188186_4_, boolean p_188186_5_) {
		return this.blockRenderer.getBlockModelRenderer().renderModel(p_188186_4_,
				this.blockRenderer.getModelForState(p_188186_2_), p_188186_2_, p_188186_1_, p_188186_3_, p_188186_5_);
	}
}
