...
public class TileEntityChestRenderer extends TileEntitySpecialRenderer<TileEntityChest> {
	...
	public void func_192841_a(TileEntityChest p_192841_1_, double p_192841_2_, double p_192841_4_, double p_192841_6_,
		...
		if (p_192841_1_.hasWorldObj()) {
			...
			if (block instanceof BlockChest && i == 0) {
				((BlockChest) block).checkForSurroundingChests(p_192841_1_.getWorld(), p_192841_1_.getPos(),
						p_192841_1_.getWorld().getBlockState(p_192841_1_.getPos()));
				i = p_192841_1_.getBlockMetadata();
			}
		...
		if (p_192841_1_.adjacentChestZNeg == null && p_192841_1_.adjacentChestXNeg == null) {
			...
			if (p_192841_1_.adjacentChestZNeg != null) {
				float f1 = p_192841_1_.adjacentChestZNeg.prevLidAngle
						+ (p_192841_1_.adjacentChestZNeg.lidAngle - p_192841_1_.adjacentChestZNeg.prevLidAngle)
								* p_192841_8_;
			...
			if (p_192841_1_.adjacentChestXNeg != null) {
				float f2 = p_192841_1_.adjacentChestXNeg.prevLidAngle
						+ (p_192841_1_.adjacentChestXNeg.lidAngle - p_192841_1_.adjacentChestXNeg.prevLidAngle)
								* p_192841_8_;
