...
public class TileEntityStructureRenderer extends TileEntitySpecialRenderer<TileEntityStructure> {
	public void func_192841_a(TileEntityStructure p_192841_1_, double p_192841_2_, double p_192841_4_,
		...
		if (Minecraft.getMinecraft().player.canUseCommandBlock() || Minecraft.getMinecraft().player.isSpectator()) {
			super.func_192841_a(p_192841_1_, p_192841_2_, p_192841_4_, p_192841_6_, p_192841_8_, p_192841_9_,
					p_192841_10_);
			...
			if (blockpos1.getX() >= 1 && blockpos1.getY() >= 1 && blockpos1.getZ() >= 1) {
				if (p_192841_1_.getMode() == TileEntityStructure.Mode.SAVE
						|| p_192841_1_.getMode() == TileEntityStructure.Mode.LOAD) {
					double d0 = 0.01D;
					...
					if (p_192841_1_.getMode() == TileEntityStructure.Mode.SAVE && p_192841_1_.showsAir()) {
						this.renderInvisibleBlocks(p_192841_1_, p_192841_2_, p_192841_4_, p_192841_6_, blockpos,
								tessellator, bufferbuilder, true);
						this.renderInvisibleBlocks(p_192841_1_, p_192841_2_, p_192841_4_, p_192841_6_, blockpos,
								tessellator, bufferbuilder, false);
					}
