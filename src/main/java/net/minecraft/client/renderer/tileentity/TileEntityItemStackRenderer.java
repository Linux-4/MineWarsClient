		...
		if (item == Items.BANNER) {
			...
			if (TileEntitySkullRenderer.instance != null) {
				...
				TileEntitySkullRenderer.instance.renderSkull(0.0F, 0.0F, 0.0F, EnumFacing.UP, 180.0F,
						p_192838_1_.getMetadata(), gameprofile, -1, 0.0F);
			...
			TileEntityRendererDispatcher.instance.func_192855_a(
					field_191274_b[BlockShulkerBox.func_190955_b(item).getMetadata()], 0.0D, 0.0D, 0.0D, 0.0F,
					p_192838_2_);
		} else {
