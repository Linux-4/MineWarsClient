...
public class Stitcher {
		...
		for (Stitcher.Holder stitcher$holder : astitcher$holder) {
			if (!this.allocateSlot(stitcher$holder)) {
				String s = String.format(
						...
						stitcher$holder.getAtlasSprite().getIconName(), stitcher$holder.getAtlasSprite().getIconWidth(),
						stitcher$holder.getAtlasSprite().getIconHeight(), this.currentWidth, this.currentHeight,
	...
	public static class Holder implements Comparable<Stitcher.Holder> {
		...
		public Holder(TextureAtlasSprite theTextureIn, int mipmapLevelHolderIn) {
			...
			this.rotated = Stitcher.getMipmapDimension(this.height, mipmapLevelHolderIn) > Stitcher
					.getMipmapDimension(this.width, mipmapLevelHolderIn);
		}
