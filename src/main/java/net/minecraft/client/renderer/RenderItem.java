...
public class RenderItem implements IResourceManagerReloadListener {
	...
	private void func_191967_a(IBakedModel p_191967_1_, int p_191967_2_, ItemStack p_191967_3_) {
		...
		for (EnumFacing enumfacing : EnumFacing.VALUES) {
			this.func_191970_a(bufferbuilder, p_191967_1_.getQuads((IBlockState) null, enumfacing, 0L), p_191967_2_,
					p_191967_3_);
		}

		this.func_191970_a(bufferbuilder, p_191967_1_.getQuads((IBlockState) null, (EnumFacing) null, 0L), p_191967_2_,
				p_191967_3_);
		tessellator.draw();
	...
	private void func_191970_a(BufferBuilder p_191970_1_, List<BakedQuad> p_191970_2_, int p_191970_3_,
			ItemStack p_191970_4_) {
	...
	public IBakedModel getItemModelWithOverrides(ItemStack stack, @Nullable World worldIn,
		...
		if (Reflector.ForgeItemOverrideList_handleItemState.exists()) {
			return (IBakedModel) Reflector.call(ibakedmodel.getOverrides(),
					Reflector.ForgeItemOverrideList_handleItemState, ibakedmodel, stack, worldIn, entitylivingbaseIn);
	...
	public void renderItem(ItemStack stack, EntityLivingBase entitylivingbaseIn,
		...
		if (!stack.func_190926_b() && entitylivingbaseIn != null) {
			IBakedModel ibakedmodel = this.getItemModelWithOverrides(stack, entitylivingbaseIn.world,
					entitylivingbaseIn);
	...
	protected void renderItemModel(ItemStack stack, IBakedModel bakedmodel,
		...
		if (!stack.func_190926_b()) {
			...
			if (Reflector.ForgeHooksClient_handleCameraTransforms.exists()) {
				bakedmodel = (IBakedModel) Reflector.call(Reflector.ForgeHooksClient_handleCameraTransforms, bakedmodel,
	...
	protected void func_191962_a(ItemStack p_191962_1_, int p_191962_2_, int p_191962_3_, IBakedModel p_191962_4_) {
		...
		if (Reflector.ForgeHooksClient_handleCameraTransforms.exists()) {
			p_191962_4_ = (IBakedModel) Reflector.call(Reflector.ForgeHooksClient_handleCameraTransforms, p_191962_4_,
	...
	public void renderItemAndEffectIntoGUI(@Nullable EntityLivingBase p_184391_1_, final ItemStack p_184391_2_,
		...
		if (!p_184391_2_.func_190926_b()) {
			...
			try {
				this.func_191962_a(p_184391_2_, p_184391_3_, p_184391_4_,
		...
		if (!stack.func_190926_b()) {
			...
			if (ReflectorForge.isItemDamaged(stack)) {
				...
				if (Reflector.ForgeItem_getDurabilityForDisplay.exists()
						&& Reflector.ForgeItem_getRGBDurabilityForDisplay.exists()) {
				...
				if (Reflector.ForgeItem_getDurabilityForDisplay.exists()
						&& Reflector.ForgeItem_getRGBDurabilityForDisplay.exists()) {
					double d1 = Reflector.callDouble(stack.getItem(), Reflector.ForgeItem_getDurabilityForDisplay,
							stack);
	...
	private void registerItems() {
		...
		for (EnumDyeColor enumdyecolor : EnumDyeColor.values()) {
			this.registerBlock(Blocks.field_192443_dR, enumdyecolor.getMetadata(),
					enumdyecolor.func_192396_c() + "_concrete");
			this.registerBlock(Blocks.field_192444_dS, enumdyecolor.getMetadata(),
					enumdyecolor.func_192396_c() + "_concrete_powder");
		}
