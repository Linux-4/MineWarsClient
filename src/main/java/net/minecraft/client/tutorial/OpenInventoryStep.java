...
public class OpenInventoryStep implements ITutorialStep {
	private static final ITextComponent field_193281_a = new TextComponentTranslation("tutorial.open_inventory.title",
			new Object[0]);
	private static final ITextComponent field_193282_b = new TextComponentTranslation(
			"tutorial.open_inventory.description", new Object[] { Tutorial.func_193291_a("inventory") });
	...
	public void func_193245_a() {
		...
		if (this.field_193283_c.func_194072_f() != GameType.SURVIVAL) {
			...
			if (this.field_193285_e >= 600 && this.field_193284_d == null) {
				this.field_193284_d = new TutorialToast(TutorialToast.Icons.RECIPE_BOOK, field_193281_a, field_193282_b,
						false);
