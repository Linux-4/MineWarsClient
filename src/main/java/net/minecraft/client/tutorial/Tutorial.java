...
public class Tutorial {
	...
	public void func_193294_a(WorldClient p_193294_1_, BlockPos p_193294_2_, IBlockState p_193294_3_,
			float p_193294_4_) {
		if (this.field_193305_b != null) {
	...
	public GameType func_194072_f() {
		return this.field_193304_a.playerController == null ? GameType.NOT_SET
				: this.field_193304_a.playerController.getCurrentGameType();
	}
