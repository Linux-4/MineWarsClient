...
public class MovementStep implements ITutorialStep {
	private static final ITextComponent field_193254_a = new TextComponentTranslation("tutorial.move.title",
			new Object[] { Tutorial.func_193291_a("forward"), Tutorial.func_193291_a("left"),
					Tutorial.func_193291_a("back"), Tutorial.func_193291_a("right") });
	private static final ITextComponent field_193255_b = new TextComponentTranslation("tutorial.move.description",
			new Object[] { Tutorial.func_193291_a("jump") });
	...
	public void func_193245_a() {
		...
		if (this.field_193261_h >= 100) {
			if (this.field_193266_m == -1 && this.field_193259_f == null) {
				this.field_193259_f = new TutorialToast(TutorialToast.Icons.MOVEMENT_KEYS, field_193254_a,
						field_193255_b, true);
				this.field_193258_e.func_193295_e().func_193033_an().func_192988_a(this.field_193259_f);
			} else if (this.field_193266_m != -1 && this.field_193261_h - this.field_193266_m >= 20
					&& this.field_193267_n == -1 && this.field_193260_g == null) {
				this.field_193260_g = new TutorialToast(TutorialToast.Icons.MOUSE, field_193256_c, field_193257_d,
						true);
	...
	public void func_193247_a(MovementInput p_193247_1_) {
		if (p_193247_1_.forwardKeyDown || p_193247_1_.backKeyDown || p_193247_1_.leftKeyDown || p_193247_1_.rightKeyDown
				|| p_193247_1_.jump) {
	...
	public void func_193249_a(MouseHelper p_193249_1_) {
		if ((double) MathHelper.abs(p_193249_1_.deltaX) > 0.01D
				|| (double) MathHelper.abs(p_193249_1_.deltaY) > 0.01D) {
