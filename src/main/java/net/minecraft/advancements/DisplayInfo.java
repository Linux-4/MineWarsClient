...
public class DisplayInfo {
	...
	public static DisplayInfo func_192294_a(JsonObject p_192294_0_, JsonDeserializationContext p_192294_1_) {
		ITextComponent itextcomponent = (ITextComponent) JsonUtils.deserializeClass(p_192294_0_, "title", p_192294_1_,
				ITextComponent.class);
		ITextComponent itextcomponent1 = (ITextComponent) JsonUtils.deserializeClass(p_192294_0_, "description",
				p_192294_1_, ITextComponent.class);
		...
		if (itextcomponent != null && itextcomponent1 != null) {
			...
			ResourceLocation resourcelocation = p_192294_0_.has("background")
					? new ResourceLocation(JsonUtils.getString(p_192294_0_, "background"))
					: null;
			FrameType frametype = p_192294_0_.has("frame")
					? FrameType.func_192308_a(JsonUtils.getString(p_192294_0_, "frame"))
					: FrameType.TASK;
