...
public class DamageSourcePredicate {
	...
	public DamageSourcePredicate(@Nullable Boolean p_i47543_1_, @Nullable Boolean p_i47543_2_,
			@Nullable Boolean p_i47543_3_, @Nullable Boolean p_i47543_4_, @Nullable Boolean p_i47543_5_,
			@Nullable Boolean p_i47543_6_, @Nullable Boolean p_i47543_7_, EntityPredicate p_i47543_8_,
	...
	public boolean func_193418_a(EntityPlayerMP p_193418_1_, DamageSource p_193418_2_) {
		if (this == field_192449_a) {
			...
			return false;
		} else if (this.field_192453_e != null
				&& this.field_192453_e.booleanValue() != p_193418_2_.canHarmInCreative()) {
			return false;
		} else if (this.field_192454_f != null
				&& this.field_192454_f.booleanValue() != p_193418_2_.isDamageAbsolute()) {
			return false;
	...
	public static DamageSourcePredicate func_192447_a(@Nullable JsonElement p_192447_0_) {
		if (p_192447_0_ != null && !p_192447_0_.isJsonNull()) {
			...
			return new DamageSourcePredicate(obool, obool1, obool2, obool3, obool4, obool5, obool6, entitypredicate,
					entitypredicate1);
		} else {
