...
public class ChangeDimensionTrigger implements ICriterionTrigger<ChangeDimensionTrigger.Instance> {
	...
	public void func_192165_a(PlayerAdvancements p_192165_1_,
			ICriterionTrigger.Listener<ChangeDimensionTrigger.Instance> p_192165_2_) {
	...
	public void func_192164_b(PlayerAdvancements p_192164_1_,
			ICriterionTrigger.Listener<ChangeDimensionTrigger.Instance> p_192164_2_) {
	...
	public ChangeDimensionTrigger.Instance func_192166_a(JsonObject p_192166_1_,
			JsonDeserializationContext p_192166_2_) {
		DimensionType dimensiontype = p_192166_1_.has("from")
				? DimensionType.func_193417_a(JsonUtils.getString(p_192166_1_, "from"))
				: null;
		DimensionType dimensiontype1 = p_192166_1_.has("to")
				? DimensionType.func_193417_a(JsonUtils.getString(p_192166_1_, "to"))
				: null;
	...
	public void func_193143_a(EntityPlayerMP p_193143_1_, DimensionType p_193143_2_, DimensionType p_193143_3_) {
		ChangeDimensionTrigger.Listeners changedimensiontrigger$listeners = this.field_193145_b
				.get(p_193143_1_.func_192039_O());
	...
	static class Listeners {
		...
		public void func_193234_a(DimensionType p_193234_1_, DimensionType p_193234_2_) {
			...
			for (ICriterionTrigger.Listener<ChangeDimensionTrigger.Instance> listener : this.field_193236_b) {
				if (((ChangeDimensionTrigger.Instance) listener.func_192158_a()).func_193190_a(p_193234_1_,
						p_193234_2_)) {
					if (list == null) {
