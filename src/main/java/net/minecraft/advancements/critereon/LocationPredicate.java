...
public class LocationPredicate {
	public static LocationPredicate field_193455_a = new LocationPredicate(MinMaxBounds.field_192516_a,
			MinMaxBounds.field_192516_a, MinMaxBounds.field_192516_a, (Biome) null, (String) null,
			(DimensionType) null);
	...
	public LocationPredicate(MinMaxBounds p_i47539_1_, MinMaxBounds p_i47539_2_, MinMaxBounds p_i47539_3_,
			@Nullable Biome p_i47539_4_, @Nullable String p_i47539_5_, @Nullable DimensionType p_i47539_6_) {
	...
	public boolean func_193453_a(WorldServer p_193453_1_, float p_193453_2_, float p_193453_3_, float p_193453_4_) {
		if (!this.field_193457_c.func_192514_a(p_193453_2_)) {
			...
			if (this.field_193456_b != null && this.field_193456_b != p_193453_1_.getBiome(blockpos)) {
				...
				return this.field_193460_f == null
						|| p_193453_1_.getChunkProvider().func_193413_a(p_193453_1_, this.field_193460_f, blockpos);
			}
		}
	}
	...
	public static LocationPredicate func_193454_a(@Nullable JsonElement p_193454_0_) {
		if (p_193454_0_ != null && !p_193454_0_.isJsonNull()) {
			...
			DimensionType dimensiontype = jsonobject.has("dimension")
					? DimensionType.func_193417_a(JsonUtils.getString(jsonobject, "dimension"))
					: null;
