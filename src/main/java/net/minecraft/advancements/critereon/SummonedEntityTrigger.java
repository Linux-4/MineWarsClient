...
public class SummonedEntityTrigger implements ICriterionTrigger<SummonedEntityTrigger.Instance> {
	...
	public void func_192165_a(PlayerAdvancements p_192165_1_,
			ICriterionTrigger.Listener<SummonedEntityTrigger.Instance> p_192165_2_) {
	...
	public void func_192164_b(PlayerAdvancements p_192164_1_,
			ICriterionTrigger.Listener<SummonedEntityTrigger.Instance> p_192164_2_) {
	...
	public SummonedEntityTrigger.Instance func_192166_a(JsonObject p_192166_1_,
	...
	public void func_192229_a(EntityPlayerMP p_192229_1_, Entity p_192229_2_) {
		SummonedEntityTrigger.Listeners summonedentitytrigger$listeners = this.field_192233_b
				.get(p_192229_1_.func_192039_O());
	...
	static class Listeners {
		...
		public void func_192533_a(EntityPlayerMP p_192533_1_, Entity p_192533_2_) {
			...
			for (ICriterionTrigger.Listener<SummonedEntityTrigger.Instance> listener : this.field_192536_b) {
				if (((SummonedEntityTrigger.Instance) listener.func_192158_a()).func_192283_a(p_192533_1_,
						p_192533_2_)) {
					if (list == null) {
