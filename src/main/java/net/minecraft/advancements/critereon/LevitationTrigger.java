...
public class LevitationTrigger implements ICriterionTrigger<LevitationTrigger.Instance> {
	...
	public void func_192165_a(PlayerAdvancements p_192165_1_,
			ICriterionTrigger.Listener<LevitationTrigger.Instance> p_192165_2_) {
	...
	public void func_192164_b(PlayerAdvancements p_192164_1_,
			ICriterionTrigger.Listener<LevitationTrigger.Instance> p_192164_2_) {
	...
	public static class Instance extends AbstractCriterionInstance {
		...
		public boolean func_193201_a(EntityPlayerMP p_193201_1_, Vec3d p_193201_2_, int p_193201_3_) {
			if (!this.field_193202_a.func_193422_a(p_193201_2_.xCoord, p_193201_2_.yCoord, p_193201_2_.zCoord,
					p_193201_1_.posX, p_193201_1_.posY, p_193201_1_.posZ)) {
				return false;
			} else {
	...
	static class Listeners {
		...
		public void func_193448_a(EntityPlayerMP p_193448_1_, Vec3d p_193448_2_, int p_193448_3_) {
			...
			for (ICriterionTrigger.Listener<LevitationTrigger.Instance> listener : this.field_193451_b) {
				if (((LevitationTrigger.Instance) listener.func_192158_a()).func_193201_a(p_193448_1_, p_193448_2_,
						p_193448_3_)) {
					if (list == null) {
