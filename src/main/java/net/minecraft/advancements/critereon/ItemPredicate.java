...
public class ItemPredicate {
	...
	public ItemPredicate(@Nullable Item p_i47540_1_, @Nullable Integer p_i47540_2_, MinMaxBounds p_i47540_3_,
			MinMaxBounds p_i47540_4_, EnchantmentPredicate[] p_i47540_5_, @Nullable PotionType p_i47540_6_,
	...
	public boolean func_192493_a(ItemStack p_192493_1_) {
		if (this.field_192496_b != null && p_192493_1_.getItem() != this.field_192496_b) {
			...
			return false;
		} else if (!this.field_193444_e
				.func_192514_a((float) (p_192493_1_.getMaxDamage() - p_192493_1_.getItemDamage()))) {
			return false;
	...
	public static ItemPredicate func_192492_a(@Nullable JsonElement p_192492_0_) {
		if (p_192492_0_ != null && !p_192492_0_.isJsonNull()) {
			...
			EnchantmentPredicate[] aenchantmentpredicate = EnchantmentPredicate
					.func_192465_b(jsonobject.get("enchantments"));
			...
			return new ItemPredicate(item, integer, minmaxbounds, minmaxbounds1, aenchantmentpredicate, potiontype,
					nbtpredicate);
		} else {
