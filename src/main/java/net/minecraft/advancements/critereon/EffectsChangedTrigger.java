...
public class EffectsChangedTrigger implements ICriterionTrigger<EffectsChangedTrigger.Instance> {
	...
	public void func_192165_a(PlayerAdvancements p_192165_1_,
			ICriterionTrigger.Listener<EffectsChangedTrigger.Instance> p_192165_2_) {
	...
	public void func_192164_b(PlayerAdvancements p_192164_1_,
			ICriterionTrigger.Listener<EffectsChangedTrigger.Instance> p_192164_2_) {
	...
	public EffectsChangedTrigger.Instance func_192166_a(JsonObject p_192166_1_,
	...
	public void func_193153_a(EntityPlayerMP p_193153_1_) {
		EffectsChangedTrigger.Listeners effectschangedtrigger$listeners = this.field_193155_b
				.get(p_193153_1_.func_192039_O());
