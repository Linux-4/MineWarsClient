...
public class ItemDurabilityTrigger implements ICriterionTrigger<ItemDurabilityTrigger.Instance> {
	...
	public void func_192165_a(PlayerAdvancements p_192165_1_,
			ICriterionTrigger.Listener<ItemDurabilityTrigger.Instance> p_192165_2_) {
	...
	public void func_192164_b(PlayerAdvancements p_192164_1_,
			ICriterionTrigger.Listener<ItemDurabilityTrigger.Instance> p_192164_2_) {
	...
	public ItemDurabilityTrigger.Instance func_192166_a(JsonObject p_192166_1_,
	...
	public void func_193158_a(EntityPlayerMP p_193158_1_, ItemStack p_193158_2_, int p_193158_3_) {
		ItemDurabilityTrigger.Listeners itemdurabilitytrigger$listeners = this.field_193160_b
				.get(p_193158_1_.func_192039_O());
	...
	static class Listeners {
		...
		public void func_193441_a(ItemStack p_193441_1_, int p_193441_2_) {
			...
			for (ICriterionTrigger.Listener<ItemDurabilityTrigger.Instance> listener : this.field_193443_b) {
				if (((ItemDurabilityTrigger.Instance) listener.func_192158_a()).func_193197_a(p_193441_1_,
						p_193441_2_)) {
					if (list == null) {
