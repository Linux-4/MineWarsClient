...
public class BredAnimalsTrigger implements ICriterionTrigger<BredAnimalsTrigger.Instance> {
	...
	public void func_192165_a(PlayerAdvancements p_192165_1_,
			ICriterionTrigger.Listener<BredAnimalsTrigger.Instance> p_192165_2_) {
	...
	public void func_192164_b(PlayerAdvancements p_192164_1_,
			ICriterionTrigger.Listener<BredAnimalsTrigger.Instance> p_192164_2_) {
	...
	public void func_192168_a(EntityPlayerMP p_192168_1_, EntityAnimal p_192168_2_, EntityAnimal p_192168_3_,
			EntityAgeable p_192168_4_) {
		BredAnimalsTrigger.Listeners bredanimalstrigger$listeners = this.field_192172_b
				.get(p_192168_1_.func_192039_O());
	...
	public static class Instance extends AbstractCriterionInstance {
		...
		public boolean func_192246_a(EntityPlayerMP p_192246_1_, EntityAnimal p_192246_2_, EntityAnimal p_192246_3_,
				EntityAgeable p_192246_4_) {
			if (!this.field_192249_c.func_192482_a(p_192246_1_, p_192246_4_)) {
				return false;
			} else {
				return this.field_192247_a.func_192482_a(p_192246_1_, p_192246_2_)
						&& this.field_192248_b.func_192482_a(p_192246_1_, p_192246_3_)
						|| this.field_192247_a.func_192482_a(p_192246_1_, p_192246_3_)
								&& this.field_192248_b.func_192482_a(p_192246_1_, p_192246_2_);
			}
		}
	}
	...
	static class Listeners {
		...
		public void func_192342_a(EntityPlayerMP p_192342_1_, EntityAnimal p_192342_2_, EntityAnimal p_192342_3_,
				EntityAgeable p_192342_4_) {
			...
			for (ICriterionTrigger.Listener<BredAnimalsTrigger.Instance> listener : this.field_192345_b) {
				if (((BredAnimalsTrigger.Instance) listener.func_192158_a()).func_192246_a(p_192342_1_, p_192342_2_,
						p_192342_3_, p_192342_4_)) {
					if (list == null) {
