...
public class CuredZombieVillagerTrigger implements ICriterionTrigger<CuredZombieVillagerTrigger.Instance> {
	...
	public void func_192165_a(PlayerAdvancements p_192165_1_,
			ICriterionTrigger.Listener<CuredZombieVillagerTrigger.Instance> p_192165_2_) {
		CuredZombieVillagerTrigger.Listeners curedzombievillagertrigger$listeners = this.field_192187_b
				.get(p_192165_1_);
	...
	public void func_192164_b(PlayerAdvancements p_192164_1_,
			ICriterionTrigger.Listener<CuredZombieVillagerTrigger.Instance> p_192164_2_) {
		CuredZombieVillagerTrigger.Listeners curedzombievillagertrigger$listeners = this.field_192187_b
				.get(p_192164_1_);
	...
	public CuredZombieVillagerTrigger.Instance func_192166_a(JsonObject p_192166_1_,
	...
	static class Listeners {
		...
		public void func_192361_a(EntityPlayerMP p_192361_1_, EntityZombie p_192361_2_, EntityVillager p_192361_3_) {
			...
			for (ICriterionTrigger.Listener<CuredZombieVillagerTrigger.Instance> listener : this.field_192363_b) {
				if (((CuredZombieVillagerTrigger.Instance) listener.func_192158_a()).func_192254_a(p_192361_1_,
						p_192361_2_, p_192361_3_)) {
					if (list == null) {
