...
public class KilledTrigger implements ICriterionTrigger<KilledTrigger.Instance> {
	...
	public void func_192165_a(PlayerAdvancements p_192165_1_,
			ICriterionTrigger.Listener<KilledTrigger.Instance> p_192165_2_) {
	...
	public void func_192164_b(PlayerAdvancements p_192164_1_,
			ICriterionTrigger.Listener<KilledTrigger.Instance> p_192164_2_) {
	...
	public KilledTrigger.Instance func_192166_a(JsonObject p_192166_1_, JsonDeserializationContext p_192166_2_) {
		return new KilledTrigger.Instance(this.field_192214_b, EntityPredicate.func_192481_a(p_192166_1_.get("entity")),
				DamageSourcePredicate.func_192447_a(p_192166_1_.get("killing_blow")));
	}
	...
	public static class Instance extends AbstractCriterionInstance {
		...
		public boolean func_192270_a(EntityPlayerMP p_192270_1_, Entity p_192270_2_, DamageSource p_192270_3_) {
			return !this.field_192272_b.func_193418_a(p_192270_1_, p_192270_3_) ? false
					: this.field_192271_a.func_192482_a(p_192270_1_, p_192270_2_);
		}
	}
	...
	static class Listeners {
		...
		public void func_192503_a(EntityPlayerMP p_192503_1_, Entity p_192503_2_, DamageSource p_192503_3_) {
			...
			for (ICriterionTrigger.Listener<KilledTrigger.Instance> listener : this.field_192506_b) {
				if (((KilledTrigger.Instance) listener.func_192158_a()).func_192270_a(p_192503_1_, p_192503_2_,
						p_192503_3_)) {
					if (list == null) {
