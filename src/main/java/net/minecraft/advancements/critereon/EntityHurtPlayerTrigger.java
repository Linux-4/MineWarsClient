...
public class EntityHurtPlayerTrigger implements ICriterionTrigger<EntityHurtPlayerTrigger.Instance> {
	...
	public void func_192165_a(PlayerAdvancements p_192165_1_,
			ICriterionTrigger.Listener<EntityHurtPlayerTrigger.Instance> p_192165_2_) {
	...
	public void func_192164_b(PlayerAdvancements p_192164_1_,
			ICriterionTrigger.Listener<EntityHurtPlayerTrigger.Instance> p_192164_2_) {
	...
	public EntityHurtPlayerTrigger.Instance func_192166_a(JsonObject p_192166_1_,
	...
	public void func_192200_a(EntityPlayerMP p_192200_1_, DamageSource p_192200_2_, float p_192200_3_,
			float p_192200_4_, boolean p_192200_5_) {
		EntityHurtPlayerTrigger.Listeners entityhurtplayertrigger$listeners = this.field_192202_b
				.get(p_192200_1_.func_192039_O());

		if (entityhurtplayertrigger$listeners != null) {
			entityhurtplayertrigger$listeners.func_192478_a(p_192200_1_, p_192200_2_, p_192200_3_, p_192200_4_,
					p_192200_5_);
		}
	}
	...
	public static class Instance extends AbstractCriterionInstance {
		...
		public boolean func_192263_a(EntityPlayerMP p_192263_1_, DamageSource p_192263_2_, float p_192263_3_,
				float p_192263_4_, boolean p_192263_5_) {
	...
	static class Listeners {
		...
		public void func_192478_a(EntityPlayerMP p_192478_1_, DamageSource p_192478_2_, float p_192478_3_,
				float p_192478_4_, boolean p_192478_5_) {
			...
			for (ICriterionTrigger.Listener<EntityHurtPlayerTrigger.Instance> listener : this.field_192480_b) {
				if (((EntityHurtPlayerTrigger.Instance) listener.func_192158_a()).func_192263_a(p_192478_1_,
						p_192478_2_, p_192478_3_, p_192478_4_, p_192478_5_)) {
					if (list == null) {
