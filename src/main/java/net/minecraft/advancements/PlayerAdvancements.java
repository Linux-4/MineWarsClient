...
public class PlayerAdvancements {
	...
	private final Map<Advancement, AdvancementProgress> field_192758_f = Maps
	...
	private void func_192740_f() {
		if (this.field_192757_e.isFile()) {
			try {
				...
				Map<ResourceLocation, AdvancementProgress> map = (Map) JsonUtils.func_193840_a(field_192754_b, s,
						field_192755_c.getType());

				if (map == null) {
					throw new JsonParseException("Found null for advancements");
				}

				Stream<Entry<ResourceLocation, AdvancementProgress>> stream = map.entrySet().stream()
				...
				for (Entry<ResourceLocation, AdvancementProgress> entry : stream.collect(Collectors.toList())) {
					...
					if (advancement == null) {
						field_192753_a.warn("Ignored advancement '" + entry.getKey() + "' in progress file "
								+ this.field_192757_e + " - it doesn't exist anymore?");
					} else {
						this.func_192743_a(advancement, entry.getValue());
					}
				}
			} catch (JsonParseException jsonparseexception) {
				field_192753_a.error("Couldn't parse player advancements in " + this.field_192757_e,
						(Throwable) jsonparseexception);
			} catch (IOException ioexception) {
				field_192753_a.error("Couldn't access player advancements in " + this.field_192757_e,
	...
	public void func_192749_b() {
		...
		try {
			...
			field_192753_a.error("Couldn't save player advancements to " + this.field_192757_e,
					(Throwable) ioexception);
		}
	}
	...
	public boolean func_192750_a(Advancement p_192750_1_, String p_192750_2_) {
		...
		if (advancementprogress.func_192109_a(p_192750_2_)) {
			...
			if (!flag1 && advancementprogress.func_192105_a()) {
				...
				if (p_192750_1_.func_192068_c() != null && p_192750_1_.func_192068_c().func_193220_i()
						&& this.field_192762_j.world.getGameRules().getBoolean("announceAdvancements")) {
					this.field_192756_d.getPlayerList().sendChatMsg(new TextComponentTranslation(
							"chat.type.advancement." + p_192750_1_.func_192068_c().func_192291_d().func_192307_a(),
							new Object[] { this.field_192762_j.getDisplayName(), p_192750_1_.func_193123_j() }));
				}
			}
		}
				...
				if (criterionprogress != null && !criterionprogress.func_192151_a()) {
					...
					if (icriterioninstance != null) {
						ICriterionTrigger<ICriterionInstance> icriteriontrigger = CriteriaTriggers
								.<ICriterionInstance>func_192119_a(icriterioninstance.func_192244_a());

						if (icriteriontrigger != null) {
							icriteriontrigger.func_192165_a(this,
	...
	private void func_193765_c(Advancement p_193765_1_) {
		...
		for (Entry<String, Criterion> entry : p_193765_1_.func_192073_f().entrySet()) {
			...
			if (criterionprogress != null
					&& (criterionprogress.func_192151_a() || advancementprogress.func_192105_a())) {
				ICriterionInstance icriterioninstance = ((Criterion) entry.getValue()).func_192143_a();
				...
				if (icriterioninstance != null) {
					...
					if (icriteriontrigger != null) {
						icriteriontrigger.func_192164_b(this,
	...
	public void func_194220_a(@Nullable Advancement p_194220_1_) {
		...
		if (advancement != this.field_194221_k) {
			this.field_192762_j.connection.sendPacket(new SPacketSelectAdvancementsTab(
					this.field_194221_k == null ? null : this.field_194221_k.func_192067_g()));
		}
	}
