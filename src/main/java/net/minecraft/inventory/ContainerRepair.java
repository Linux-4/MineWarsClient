	...
	public ContainerRepair(InventoryPlayer playerInventory, final World worldIn, final BlockPos blockPosIn,
		...
		this.addSlotToContainer(new Slot(this.outputSlot, 2, 134, 47) {
			...
			public ItemStack func_190901_a(EntityPlayer p_190901_1_, ItemStack p_190901_2_) {
				...
				if (!p_190901_1_.capabilities.isCreativeMode && !worldIn.isRemote
						&& iblockstate.getBlock() == Blocks.ANVIL && p_190901_1_.getRNG().nextFloat() < 0.12F) {
	...
	public void updateRepairOutput() {
		...
		if (itemstack.func_190926_b()) {
			...
			if (!itemstack2.func_190926_b()) {
				boolean flag = itemstack2.getItem() == Items.ENCHANTED_BOOK
