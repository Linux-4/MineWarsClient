...
public class RecipeBookServer extends RecipeBook {
	...
	private void func_194081_a(SPacketRecipeBook.State p_194081_1_, EntityPlayerMP p_194081_2_,
			List<IRecipe> p_194081_3_) {
		p_194081_2_.connection.sendPacket(new SPacketRecipeBook(p_194081_1_, p_194081_3_, Collections.emptyList(),
				this.field_192818_b, this.field_192819_c));
	}
	...
	public NBTTagCompound func_192824_e() {
		...
		for (IRecipe irecipe : this.func_194079_d()) {
			nbttaglist.appendTag(new NBTTagString(
					((ResourceLocation) CraftingManager.field_193380_a.getNameForObject(irecipe)).toString()));
		}
		...
		for (IRecipe irecipe1 : this.func_194080_e()) {
			nbttaglist1.appendTag(new NBTTagString(
					((ResourceLocation) CraftingManager.field_193380_a.getNameForObject(irecipe1)).toString()));
		}
	...
	public void func_192826_c(EntityPlayerMP p_192826_1_) {
		p_192826_1_.connection.sendPacket(new SPacketRecipeBook(SPacketRecipeBook.State.INIT, this.func_194079_d(),
				this.func_194080_e(), this.field_192818_b, this.field_192819_c));
	}
}
