...
public class Chunk {
	...
	public int getLightFor(EnumSkyBlock p_177413_1_, BlockPos pos) {
		...
		if (extendedblockstorage == NULL_BLOCK_STORAGE) {
			...
			return p_177413_1_ == EnumSkyBlock.BLOCK ? extendedblockstorage.getExtBlocklightValue(i, j & 15, k)
	...
	public int getLightSubtracted(BlockPos pos, int amount) {
		...
		if (extendedblockstorage == NULL_BLOCK_STORAGE) {
			return this.worldObj.provider.func_191066_m() && amount < EnumSkyBlock.SKY.defaultLightValue
					? EnumSkyBlock.SKY.defaultLightValue - amount
					: 0;
		} else {
			int l = !this.worldObj.provider.func_191066_m() ? 0
