...
public class ChunkPrimer {
	...
	/**
	 * Counting down from the highest block in the sky, find the first non-air block
	 * for the given location (actually, looks like mostly checks x, z+1? And
	 * actually checks only the very top sky block of actual x, z)
	 */
