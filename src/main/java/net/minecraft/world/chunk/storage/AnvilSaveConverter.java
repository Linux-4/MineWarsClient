...
public class AnvilSaveConverter extends SaveFormatOld {
	...
	public boolean convertMapFormat(String filename, IProgressUpdate progressCallback) {
		...
		this.convertFile(new File(file2, "region"), list1, new BiomeProviderSingle(Biomes.HELL), list.size(), i,
				progressCallback);
		this.convertFile(new File(file3, "region"), list2, new BiomeProviderSingle(Biomes.SKY),
