...
public final class WorldEntitySpawner {
				...
				if ((!enumcreaturetype.getPeacefulCreature() || spawnPeacefulMobs)
					...
					if (k4 <= l4) {
						...
						for (ChunkPos chunkpos1 : this.eligibleChunksForSpawning) {
							BlockPos blockpos = getRandomChunkPosition(worldServerIn, chunkpos1.chunkXPos,
									chunkpos1.chunkZPos);
									...
									for (int i4 = 0; i4 < l3; ++i4) {
										...
										if (!worldServerIn.isAnyPlayerWithinRangeAt((double) f, (double) i3,
											...
											if (worldServerIn.canCreatureTypeSpawnHere(enumcreaturetype,
													biome$spawnlistentry, blockpos$mutableblockpos)
												...
												try {
													entityliving = biome$spawnlistentry.entityClass
															.getConstructor(World.class).newInstance(worldServerIn);
	 ...
	 */
	public static void performWorldGenSpawning(World worldIn, Biome biomeIn, int p_77191_2_, int p_77191_3_,
