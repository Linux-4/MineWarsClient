...
public enum GameType {
	NOT_SET(-1, "", ""), SURVIVAL(0, "survival", "s"), CREATIVE(1, "creative", "c"), ADVENTURE(2, "adventure", "a"),
	...
	/**
	 * Gets the game type registered with the specified name. If no matches were
	 * found, survival will be returned.
	 */
