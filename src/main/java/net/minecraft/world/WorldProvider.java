...
public abstract class WorldProvider {
	...
	public IChunkGenerator createChunkGenerator() {
		if (this.terrainType == WorldType.FLAT) {
			return new ChunkGeneratorFlat(this.worldObj, this.worldObj.getSeed(),
			...
			return this.terrainType == WorldType.CUSTOMIZED
					? new ChunkGeneratorOverworld(this.worldObj, this.worldObj.getSeed(),
							this.worldObj.getWorldInfo().isMapFeaturesEnabled(), this.generatorSettings)
					: new ChunkGeneratorOverworld(this.worldObj, this.worldObj.getSeed(),
							this.worldObj.getWorldInfo().isMapFeaturesEnabled(), this.generatorSettings);
		}
	...
	/**
	 * Called when the world is performing a save. Only used to save the state of
	 * the Dragon Boss fight in WorldProviderEnd in Vanilla.
	 */
	public void onWorldSave() {
	}

	/**
	 * Called when the world is updating entities. Only used in WorldProviderEnd to
	 * update the DragonFightManager in Vanilla.
	 */
	public void onWorldUpdateEntities() {
	}

	/**
	 * Called to determine if the chunk at the given chunk coordinates within the
	 * provider's world can be dropped. Used in WorldProviderSurface to prevent
	 * spawn chunks from being unloaded.
	 */
