...
public class ChunkGeneratorOverworld implements IChunkGenerator {
	...
	public void replaceBiomeBlocks(int x, int z, ChunkPrimer primer, Biome[] biomesIn) {
		...
		for (int i = 0; i < 16; ++i) {
			for (int j = 0; j < 16; ++j) {
				...
				biome.genTerrainBlocks(this.worldObj, this.rand, primer, x * 16 + i, z * 16 + j,
	...
	public boolean func_193414_a(World p_193414_1_, String p_193414_2_, BlockPos p_193414_3_) {
		if (!this.mapFeaturesEnabled) {
			...
			return "Temple".equals(p_193414_2_) && this.scatteredFeatureGenerator != null
					? this.scatteredFeatureGenerator.isInsideStructure(p_193414_3_)
					: false;
		}
	}
