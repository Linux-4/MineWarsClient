		...
		for (int i = 0; i < areaHeight; ++i) {
			for (int j = 0; j < areaWidth; ++j) {
				...
				if (k == Biome.getIdForBiome(Biomes.MUSHROOM_ISLAND)) {
					...
					if (this.isJungleCompatible(i2) && this.isJungleCompatible(l2) && this.isJungleCompatible(k3)
					...
					if (biome != null && biome.isSnowyBiome()) {
						this.replaceIfNeighborOcean(aint, aint1, j, i, areaWidth, k,
								Biome.getIdForBiome(Biomes.COLD_BEACH));
					} else if (k != Biome.getIdForBiome(Biomes.MESA) && k != Biome.getIdForBiome(Biomes.MESA_ROCK)) {
						if (k != Biome.getIdForBiome(Biomes.OCEAN) && k != Biome.getIdForBiome(Biomes.DEEP_OCEAN)
	...
	private boolean isJungleCompatible(int p_151631_1_) {
		if (Biome.getBiome(p_151631_1_) != null && Biome.getBiome(p_151631_1_).getBiomeClass() == BiomeJungle.class) {
			...
			return p_151631_1_ == Biome.getIdForBiome(Biomes.JUNGLE_EDGE)
					...
					|| p_151631_1_ == Biome.getIdForBiome(Biomes.TAIGA) || isBiomeOceanic(p_151631_1_);
		}
	}
