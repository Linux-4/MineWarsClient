...
public abstract class WorldGenHugeTrees extends WorldGenAbstractTree {
	...
	/**
	 * calculates the height based on this trees base height and its extra random
	 * height
	 */
	...
	/**
	 * returns whether or not there is space for a tree to grow at a certain
	 * position
	 */
	...
	/**
	 * returns whether or not there is dirt underneath the block where the tree will
	 * be grown. It also generates dirt around the block in a 2x2 square if there is
	 * dirt underneath the blockpos.
	 */
	...
	/**
	 * returns whether or not a tree can grow at a specific position. If it can, it
	 * generates surrounding dirt underneath.
	 */
