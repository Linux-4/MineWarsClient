...
public class WorldGenDungeons extends WorldGenerator {
	...
	private static final ResourceLocation[] SPAWNERTYPES = new ResourceLocation[] {
			EntityList.func_191306_a(EntitySkeleton.class), EntityList.func_191306_a(EntityZombie.class),
			EntityList.func_191306_a(EntityZombie.class), EntityList.func_191306_a(EntitySpider.class) };
	...
	public boolean generate(World worldIn, Random rand, BlockPos position) {
		...
		if (j2 >= 1 && j2 <= 5) {
			...
			if (tileentity instanceof TileEntityMobSpawner) {
				...
				LOGGER.error("Failed to fetch mob spawner entity at ({}, {}, {})", Integer.valueOf(position.getX()),
						Integer.valueOf(position.getY()), Integer.valueOf(position.getZ()));
			}
