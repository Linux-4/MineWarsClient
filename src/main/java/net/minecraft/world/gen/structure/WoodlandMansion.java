...
public class WoodlandMansion extends MapGenStructure {
	...
	public static final List<Biome> field_191072_a = Arrays.<Biome>asList(Biomes.ROOFED_FOREST,
	...
	protected boolean canSpawnStructureAtCoords(int chunkX, int chunkZ) {
		...
		if (chunkX == k && chunkZ == l) {
			boolean flag = this.worldObj.getBiomeProvider().areBiomesViable(chunkX * 16 + 8, chunkZ * 16 + 8, 32,
					field_191072_a);
	...
	public BlockPos getClosestStrongholdPos(World worldIn, BlockPos pos, boolean p_180706_3_) {
		...
		return biomeprovider.func_190944_c() && biomeprovider.func_190943_d() != Biomes.ROOFED_FOREST ? null
				: func_191069_a(worldIn, this, pos, 80, 20, 10387319, true, 100, p_180706_3_);
	}
	...
	public static class Start extends StructureStart {
		...
		private void func_191092_a(World p_191092_1_, ChunkGeneratorOverworld p_191092_2_, Random p_191092_3_,
				int p_191092_4_, int p_191092_5_) {
			...
			if (k1 < 60) {
				...
				WoodlandMansionPieces.func_191152_a(p_191092_1_.getSaveHandler().getStructureTemplateManager(),
						blockpos, rotation, list, p_191092_3_);
