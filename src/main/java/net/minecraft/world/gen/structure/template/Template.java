...
public class Template {
	...
	public void takeBlocksFromWorld(World worldIn, BlockPos startPos, BlockPos endPos, boolean takeEntities,
		...
		if (endPos.getX() >= 1 && endPos.getY() >= 1 && endPos.getZ() >= 1) {
			...
			for (BlockPos.MutableBlockPos blockpos$mutableblockpos : BlockPos.getAllInBoxMutable(blockpos1,
					blockpos2)) {
	...
	private void takeEntitiesFromWorld(World worldIn, BlockPos startPos, BlockPos endPos) {
		List<Entity> list = worldIn.<Entity>getEntitiesWithinAABB(Entity.class, new AxisAlignedBB(startPos, endPos),
		...
		for (Entity entity : list) {
			Vec3d vec3d = new Vec3d(entity.posX - (double) startPos.getX(), entity.posY - (double) startPos.getY(),
	...
	public void addBlocksToWorld(World p_189960_1_, BlockPos p_189960_2_, @Nullable ITemplateProcessor p_189960_3_,
			PlacementSettings p_189960_4_, int p_189960_5_) {
		if ((!this.blocks.isEmpty() || !p_189960_4_.getIgnoreEntities() && !this.entities.isEmpty())
			...
			for (Template.BlockInfo template$blockinfo : this.blocks) {
				...
				Template.BlockInfo template$blockinfo1 = p_189960_3_ != null
						? p_189960_3_.processBlock(p_189960_1_, blockpos, template$blockinfo)
						: template$blockinfo;
			...
			if (!p_189960_4_.getIgnoreEntities()) {
				this.addEntitiesToWorld(p_189960_1_, p_189960_2_, p_189960_4_.getMirror(), p_189960_4_.getRotation(),
	...
	public static BlockPos func_191157_a(BlockPos p_191157_0_, Mirror p_191157_1_, Rotation p_191157_2_,
	...
	public NBTTagCompound writeToNBT(NBTTagCompound nbt) {
		...
		for (Template.EntityInfo template$entityinfo : this.entities) {
			...
			nbttagcompound1.setTag("pos", this.writeDoubles(template$entityinfo.pos.xCoord,
					template$entityinfo.pos.yCoord, template$entityinfo.pos.zCoord));
