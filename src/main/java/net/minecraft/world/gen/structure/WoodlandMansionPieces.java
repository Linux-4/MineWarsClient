...
public class WoodlandMansionPieces {
	...
	public static void func_191152_a(TemplateManager p_191152_0_, BlockPos p_191152_1_, Rotation p_191152_2_,
		...
		WoodlandMansionPieces.Placer woodlandmansionpieces$placer = new WoodlandMansionPieces.Placer(p_191152_0_,
				p_191152_4_);
	...
	static class Grid {
		...
		public Grid(Random p_i47362_1_) {
			...
			this.field_191118_b.func_191142_a(this.field_191121_e, this.field_191122_f, this.field_191121_e + 1,
					this.field_191122_f + 1, 3);
			this.field_191118_b.func_191142_a(this.field_191121_e - 1, this.field_191122_f, this.field_191121_e - 1,
					this.field_191122_f + 1, 2);
			this.field_191118_b.func_191142_a(this.field_191121_e + 2, this.field_191122_f - 2, this.field_191121_e + 3,
					this.field_191122_f + 3, 5);
			this.field_191118_b.func_191142_a(this.field_191121_e + 1, this.field_191122_f - 2, this.field_191121_e + 1,
					this.field_191122_f - 1, 1);
			this.field_191118_b.func_191142_a(this.field_191121_e + 1, this.field_191122_f + 2, this.field_191121_e + 1,
					this.field_191122_f + 3, 1);
			...
			this.func_191110_a(this.field_191118_b, this.field_191121_e - 2, this.field_191122_f - 1, EnumFacing.WEST,
					3);
			this.func_191110_a(this.field_191118_b, this.field_191121_e - 2, this.field_191122_f + 2, EnumFacing.WEST,
					3);
			...
			this.field_191120_d[0].func_191142_a(this.field_191121_e + 1, this.field_191122_f, this.field_191121_e + 1,
					this.field_191122_f + 1, 8388608);
			this.field_191120_d[1].func_191142_a(this.field_191121_e + 1, this.field_191122_f, this.field_191121_e + 1,
					this.field_191122_f + 1, 8388608);
			this.field_191119_c = new WoodlandMansionPieces.SimpleGrid(this.field_191118_b.field_191149_b,
					this.field_191118_b.field_191150_c, 5);
			this.func_191115_b();
			this.func_191116_a(this.field_191119_c, this.field_191120_d[2]);
		}

		public static boolean func_191109_a(WoodlandMansionPieces.SimpleGrid p_191109_0_, int p_191109_1_,
				int p_191109_2_) {
			int i = p_191109_0_.func_191145_a(p_191109_1_, p_191109_2_);
			return i == 1 || i == 2 || i == 3 || i == 4;
		}

		public boolean func_191114_a(WoodlandMansionPieces.SimpleGrid p_191114_1_, int p_191114_2_, int p_191114_3_,
		...
		@Nullable
		public EnumFacing func_191113_b(WoodlandMansionPieces.SimpleGrid p_191113_1_, int p_191113_2_, int p_191113_3_,
				int p_191113_4_, int p_191113_5_) {
			for (EnumFacing enumfacing : EnumFacing.Plane.HORIZONTAL.facings()) {
				if (this.func_191114_a(p_191113_1_, p_191113_2_ + enumfacing.getFrontOffsetX(),
						p_191113_3_ + enumfacing.getFrontOffsetZ(), p_191113_4_, p_191113_5_)) {
					return enumfacing;
				}
			}
		...
		private void func_191110_a(WoodlandMansionPieces.SimpleGrid p_191110_1_, int p_191110_2_, int p_191110_3_,
				EnumFacing p_191110_4_, int p_191110_5_) {
			if (p_191110_5_ > 0) {
				p_191110_1_.func_191144_a(p_191110_2_, p_191110_3_, 1);
				p_191110_1_.func_191141_a(p_191110_2_ + p_191110_4_.getFrontOffsetX(),
						p_191110_3_ + p_191110_4_.getFrontOffsetZ(), 0, 1);

				for (int i = 0; i < 8; ++i) {
					EnumFacing enumfacing = EnumFacing.getHorizontal(this.field_191117_a.nextInt(4));

					if (enumfacing != p_191110_4_.getOpposite()
							&& (enumfacing != EnumFacing.EAST || !this.field_191117_a.nextBoolean())) {
						int j = p_191110_2_ + p_191110_4_.getFrontOffsetX();
						int k = p_191110_3_ + p_191110_4_.getFrontOffsetZ();

						if (p_191110_1_.func_191145_a(j + enumfacing.getFrontOffsetX(),
								k + enumfacing.getFrontOffsetZ()) == 0
								&& p_191110_1_.func_191145_a(j + enumfacing.getFrontOffsetX() * 2,
										k + enumfacing.getFrontOffsetZ() * 2) == 0) {
							this.func_191110_a(p_191110_1_,
				...
				p_191110_1_.func_191141_a(p_191110_2_ + enumfacing1.getFrontOffsetX(),
						p_191110_3_ + enumfacing1.getFrontOffsetZ(), 0, 2);
				p_191110_1_.func_191141_a(p_191110_2_ + enumfacing2.getFrontOffsetX(),
						p_191110_3_ + enumfacing2.getFrontOffsetZ(), 0, 2);
				p_191110_1_.func_191141_a(p_191110_2_ + p_191110_4_.getFrontOffsetX() + enumfacing1.getFrontOffsetX(),
						p_191110_3_ + p_191110_4_.getFrontOffsetZ() + enumfacing1.getFrontOffsetZ(), 0, 2);
				p_191110_1_.func_191141_a(p_191110_2_ + p_191110_4_.getFrontOffsetX() + enumfacing2.getFrontOffsetX(),
						p_191110_3_ + p_191110_4_.getFrontOffsetZ() + enumfacing2.getFrontOffsetZ(), 0, 2);
				p_191110_1_.func_191141_a(p_191110_2_ + p_191110_4_.getFrontOffsetX() * 2,
						p_191110_3_ + p_191110_4_.getFrontOffsetZ() * 2, 0, 2);
				p_191110_1_.func_191141_a(p_191110_2_ + enumfacing1.getFrontOffsetX() * 2,
						p_191110_3_ + enumfacing1.getFrontOffsetZ() * 2, 0, 2);
				p_191110_1_.func_191141_a(p_191110_2_ + enumfacing2.getFrontOffsetX() * 2,
						p_191110_3_ + enumfacing2.getFrontOffsetZ() * 2, 0, 2);
			}
		}
		...
		private void func_191115_b() {
			...
			if (list.isEmpty()) {
				this.field_191119_c.func_191142_a(0, 0, this.field_191119_c.field_191149_b,
						this.field_191119_c.field_191150_c, 5);
			} else {
				Tuple<Integer, Integer> tuple = (Tuple) list.get(this.field_191117_a.nextInt(list.size()));
				int l1 = woodlandmansionpieces$simplegrid.func_191145_a(((Integer) tuple.getFirst()).intValue(),
						((Integer) tuple.getSecond()).intValue());
				woodlandmansionpieces$simplegrid.func_191144_a(((Integer) tuple.getFirst()).intValue(),
						((Integer) tuple.getSecond()).intValue(), l1 | 4194304);
				EnumFacing enumfacing1 = this.func_191113_b(this.field_191118_b,
						((Integer) tuple.getFirst()).intValue(), ((Integer) tuple.getSecond()).intValue(), 1,
						l1 & 65535);
				...
				for (EnumFacing enumfacing : EnumFacing.Plane.HORIZONTAL.facings()) {
					if (this.field_191119_c.func_191145_a(i2 + enumfacing.getFrontOffsetX(),
							i1 + enumfacing.getFrontOffsetZ()) == 0) {
				...
				if (list1.isEmpty()) {
					this.field_191119_c.func_191142_a(0, 0, this.field_191119_c.field_191149_b,
							this.field_191119_c.field_191150_c, 5);
					woodlandmansionpieces$simplegrid.func_191144_a(((Integer) tuple.getFirst()).intValue(),
							((Integer) tuple.getSecond()).intValue(), l1);
				} else {
					EnumFacing enumfacing2 = list1.get(this.field_191117_a.nextInt(list1.size()));
					this.func_191110_a(this.field_191119_c, i2 + enumfacing2.getFrontOffsetX(),
							i1 + enumfacing2.getFrontOffsetZ(), enumfacing2, 4);
		...
		private void func_191116_a(WoodlandMansionPieces.SimpleGrid p_191116_1_,
			...
			for (Tuple<Integer, Integer> tuple : list) {
				...
				if (p_191116_2_.func_191145_a(k, l) == 0) {
					...
					if (p_191116_2_.func_191145_a(k + 1, l) == 0 && p_191116_2_.func_191145_a(k, l + 1) == 0
							&& p_191116_2_.func_191145_a(k + 1, l + 1) == 0 && p_191116_1_.func_191145_a(k + 1, l) == 2
							&& p_191116_1_.func_191145_a(k, l + 1) == 2
							&& p_191116_1_.func_191145_a(k + 1, l + 1) == 2) {
						j1 = k + 1;
						l1 = l + 1;
						i2 = 262144;
					} else if (p_191116_2_.func_191145_a(k - 1, l) == 0 && p_191116_2_.func_191145_a(k, l + 1) == 0
							&& p_191116_2_.func_191145_a(k - 1, l + 1) == 0 && p_191116_1_.func_191145_a(k - 1, l) == 2
							&& p_191116_1_.func_191145_a(k, l + 1) == 2
							&& p_191116_1_.func_191145_a(k - 1, l + 1) == 2) {
						i1 = k - 1;
	...
	public static class MansionTemplate extends StructureComponentTemplate {
		...
		private void func_191081_a(TemplateManager p_191081_1_) {
			Template template = p_191081_1_.getTemplate((MinecraftServer) null,
					new ResourceLocation("mansion/" + this.field_191082_d));
			PlacementSettings placementsettings = (new PlacementSettings()).setIgnoreEntities(true)
					.setRotation(this.field_191083_e).setMirror(this.field_191084_f);
		...
		protected void handleDataMarker(String p_186175_1_, BlockPos p_186175_2_, World p_186175_3_, Random p_186175_4_,
			...
			if (p_186175_1_.startsWith("Chest")) {
				...
				this.func_191080_a(p_186175_3_, p_186175_5_, p_186175_4_, p_186175_2_, LootTableList.field_191192_o,
						iblockstate);
				...
				entityvindicator.onInitialSpawn(p_186175_3_.getDifficultyForLocation(new BlockPos(entityvindicator)),
	...
	static class Placer {
		...
		public void func_191125_a(BlockPos p_191125_1_, Rotation p_191125_2_,
			...
			woodlandmansionpieces$placementdata1.field_191139_b = woodlandmansionpieces$placementdata.field_191139_b
					.up(8);
			...
			this.func_191130_a(p_191125_3_, woodlandmansionpieces$placementdata, woodlandmansionpieces$simplegrid,
					EnumFacing.SOUTH, this.field_191136_c, this.field_191137_d, i, j);
			this.func_191130_a(p_191125_3_, woodlandmansionpieces$placementdata1, woodlandmansionpieces$simplegrid,
					EnumFacing.SOUTH, this.field_191136_c, this.field_191137_d, i, j);
			WoodlandMansionPieces.PlacementData woodlandmansionpieces$placementdata2 = new WoodlandMansionPieces.PlacementData();
			woodlandmansionpieces$placementdata2.field_191139_b = woodlandmansionpieces$placementdata.field_191139_b
					.up(19);
			...
			for (int k = 0; k < woodlandmansionpieces$simplegrid1.field_191150_c && !flag; ++k) {
				for (int l = woodlandmansionpieces$simplegrid1.field_191149_b - 1; l >= 0 && !flag; --l) {
					if (WoodlandMansionPieces.Grid.func_191109_a(woodlandmansionpieces$simplegrid1, l, k)) {
						woodlandmansionpieces$placementdata2.field_191139_b = woodlandmansionpieces$placementdata2.field_191139_b
								.offset(p_191125_2_.rotate(EnumFacing.SOUTH), 8 + (k - this.field_191137_d) * 8);
						woodlandmansionpieces$placementdata2.field_191139_b = woodlandmansionpieces$placementdata2.field_191139_b
								.offset(p_191125_2_.rotate(EnumFacing.EAST), (l - this.field_191136_c) * 8);
						this.func_191131_b(p_191125_3_, woodlandmansionpieces$placementdata2);
						this.func_191130_a(p_191125_3_, woodlandmansionpieces$placementdata2,
								woodlandmansionpieces$simplegrid1, EnumFacing.SOUTH, l, k, l, k);
						flag = true;
					}
				}
			}

			this.func_191123_a(p_191125_3_, p_191125_1_.up(16), p_191125_2_, woodlandmansionpieces$simplegrid,
					woodlandmansionpieces$simplegrid1);
			this.func_191123_a(p_191125_3_, p_191125_1_.up(27), p_191125_2_, woodlandmansionpieces$simplegrid1,
				...
				for (int i1 = 0; i1 < woodlandmansionpieces$simplegrid3.field_191150_c; ++i1) {
					for (int j1 = 0; j1 < woodlandmansionpieces$simplegrid3.field_191149_b; ++j1) {
						if (woodlandmansionpieces$simplegrid3.func_191145_a(j1, i1) == 1) {
							BlockPos blockpos1 = blockpos.offset(p_191125_2_.rotate(EnumFacing.SOUTH),
									8 + (i1 - this.field_191137_d) * 8);
							blockpos1 = blockpos1.offset(p_191125_2_.rotate(EnumFacing.EAST),
									(j1 - this.field_191136_c) * 8);
							p_191125_3_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a,
									"corridor_floor", blockpos1, p_191125_2_));

							if (woodlandmansionpieces$simplegrid3.func_191145_a(j1, i1 - 1) == 1
									|| (woodlandmansionpieces$simplegrid2.func_191145_a(j1, i1 - 1)
											& 8388608) == 8388608) {
								p_191125_3_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a,
										"carpet_north", blockpos1.offset(p_191125_2_.rotate(EnumFacing.EAST), 1).up(),
										p_191125_2_));
							}

							if (woodlandmansionpieces$simplegrid3.func_191145_a(j1 + 1, i1) == 1
									|| (woodlandmansionpieces$simplegrid2.func_191145_a(j1 + 1, i1)
											& 8388608) == 8388608) {
								p_191125_3_.add(
										new WoodlandMansionPieces.MansionTemplate(this.field_191134_a, "carpet_east",
												blockpos1.offset(p_191125_2_.rotate(EnumFacing.SOUTH), 1)
														.offset(p_191125_2_.rotate(EnumFacing.EAST), 5).up(),
												p_191125_2_));
							}
							...
							if (woodlandmansionpieces$simplegrid3.func_191145_a(j1, i1 + 1) == 1
									|| (woodlandmansionpieces$simplegrid2.func_191145_a(j1, i1 + 1)
											& 8388608) == 8388608) {
								p_191125_3_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a, s,
							...
							if (woodlandmansionpieces$simplegrid3.func_191145_a(j1 - 1, i1) == 1
									|| (woodlandmansionpieces$simplegrid2.func_191145_a(j1 - 1, i1)
											& 8388608) == 8388608) {
								p_191125_3_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a, s1,
					...
					for (int l1 = 0; l1 < woodlandmansionpieces$simplegrid3.field_191149_b; ++l1) {
						...
						if (woodlandmansionpieces$simplegrid3.func_191145_a(l1, k1) == 2 || flag1) {
							...
							if ((i2 & 2097152) == 2097152) {
								for (EnumFacing enumfacing : EnumFacing.Plane.HORIZONTAL.facings()) {
									if (woodlandmansionpieces$simplegrid3.func_191145_a(
											l1 + enumfacing.getFrontOffsetX(),
											k1 + enumfacing.getFrontOffsetZ()) == 1) {
										list.add(enumfacing);
									}
								}
							}
							...
							BlockPos blockpos2 = blockpos.offset(p_191125_2_.rotate(EnumFacing.SOUTH),
									8 + (k1 - this.field_191137_d) * 8);
							blockpos2 = blockpos2.offset(p_191125_2_.rotate(EnumFacing.EAST),
									-1 + (l1 - this.field_191136_c) * 8);

							if (WoodlandMansionPieces.Grid.func_191109_a(woodlandmansionpieces$simplegrid3, l1 - 1, k1)
									&& !p_191125_4_.func_191114_a(woodlandmansionpieces$simplegrid3, l1 - 1, k1, l2,
											k2)) {
								p_191125_3_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a,
										enumfacing1 == EnumFacing.WEST ? s3 : s2, blockpos2, p_191125_2_));
							}
							...
							if (woodlandmansionpieces$simplegrid3.func_191145_a(l1 + 1, k1) == 1 && !flag1) {
								...
								p_191125_3_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a,
										enumfacing1 == EnumFacing.EAST ? s3 : s2, blockpos3, p_191125_2_));
							}

							if (WoodlandMansionPieces.Grid.func_191109_a(woodlandmansionpieces$simplegrid3, l1, k1 + 1)
									&& !p_191125_4_.func_191114_a(woodlandmansionpieces$simplegrid3, l1, k1 + 1, l2,
											k2)) {
								...
								p_191125_3_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a,
										enumfacing1 == EnumFacing.SOUTH ? s3 : s2, blockpos4,
							...
							if (woodlandmansionpieces$simplegrid3.func_191145_a(l1, k1 - 1) == 1 && !flag1) {
								...
								p_191125_3_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a,
										enumfacing1 == EnumFacing.NORTH ? s3 : s2, blockpos5,
										p_191125_2_.add(Rotation.CLOCKWISE_90)));
							}

							if (j2 == 65536) {
								this.func_191129_a(p_191125_3_, blockpos2, p_191125_2_, enumfacing1,
										awoodlandmansionpieces$roomcollection[l2]);
							} else if (j2 == 131072 && enumfacing1 != null) {
								EnumFacing enumfacing3 = p_191125_4_.func_191113_b(woodlandmansionpieces$simplegrid3,
										l1, k1, l2, k2);
								boolean flag2 = (i2 & 4194304) == 4194304;
								this.func_191132_a(p_191125_3_, blockpos2, p_191125_2_, enumfacing3, enumfacing1,
										awoodlandmansionpieces$roomcollection[l2], flag2);
							} else if (j2 == 262144 && enumfacing1 != null && enumfacing1 != EnumFacing.UP) {
								EnumFacing enumfacing2 = enumfacing1.rotateY();

								if (!p_191125_4_.func_191114_a(woodlandmansionpieces$simplegrid3,
										l1 + enumfacing2.getFrontOffsetX(), k1 + enumfacing2.getFrontOffsetZ(), l2,
										k2)) {
									enumfacing2 = enumfacing2.getOpposite();
								}

								this.func_191127_a(p_191125_3_, blockpos2, p_191125_2_, enumfacing2, enumfacing1,
										awoodlandmansionpieces$roomcollection[l2]);
							} else if (j2 == 262144 && enumfacing1 == EnumFacing.UP) {
								this.func_191128_a(p_191125_3_, blockpos2, p_191125_2_,
										awoodlandmansionpieces$roomcollection[l2]);
							}
						}
					}
		...
		private void func_191130_a(List<WoodlandMansionPieces.MansionTemplate> p_191130_1_,
			...
			while (true) {
				if (!WoodlandMansionPieces.Grid.func_191109_a(p_191130_3_, i + p_191130_4_.getFrontOffsetX(),
				...
				} else if (WoodlandMansionPieces.Grid.func_191109_a(p_191130_3_, i + p_191130_4_.getFrontOffsetX(),
						j + p_191130_4_.getFrontOffsetZ())
						&& WoodlandMansionPieces.Grid.func_191109_a(p_191130_3_,
								i + p_191130_4_.getFrontOffsetX() + p_191130_4_.rotateYCCW().getFrontOffsetX(),
								j + p_191130_4_.getFrontOffsetZ() + p_191130_4_.rotateYCCW().getFrontOffsetZ())) {
		...
		private void func_191123_a(List<WoodlandMansionPieces.MansionTemplate> p_191123_1_, BlockPos p_191123_2_,
			...
			for (int i = 0; i < p_191123_4_.field_191150_c; ++i) {
				for (int j = 0; j < p_191123_4_.field_191149_b; ++j) {
					BlockPos lvt_8_3_ = p_191123_2_.offset(p_191123_3_.rotate(EnumFacing.SOUTH),
							8 + (i - this.field_191137_d) * 8);
					...
					if (WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j, i) && !flag) {
						p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a, "roof",
								lvt_8_3_.up(3), p_191123_3_));
						...
						if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j + 1, i)) {
							...
							p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a, "roof_front",
									blockpos1, p_191123_3_));
						}
						...
						if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j - 1, i)) {
							...
							p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a, "roof_front",
									blockpos5, p_191123_3_.add(Rotation.CLOCKWISE_180)));
						}
						...
						if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j, i - 1)) {
							...
							p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a, "roof_front",
									blockpos6, p_191123_3_.add(Rotation.COUNTERCLOCKWISE_90)));
						}
						...
						if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j, i + 1)) {
							...
							p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a, "roof_front",
									blockpos7, p_191123_3_.add(Rotation.CLOCKWISE_90)));
						}
					}
				}
			}
			...
			if (p_191123_5_ != null) {
				for (int k = 0; k < p_191123_4_.field_191150_c; ++k) {
					for (int i1 = 0; i1 < p_191123_4_.field_191149_b; ++i1) {
						BlockPos blockpos3 = p_191123_2_.offset(p_191123_3_.rotate(EnumFacing.SOUTH),
								8 + (k - this.field_191137_d) * 8);
						blockpos3 = blockpos3.offset(p_191123_3_.rotate(EnumFacing.EAST),
								(i1 - this.field_191136_c) * 8);
						...
						if (WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, i1, k) && flag1) {
							if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, i1 + 1, k)) {
								...
								p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a,
										"small_wall", blockpos8, p_191123_3_));
							}
							...
							if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, i1 - 1, k)) {
								...
								p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a,
										"small_wall", blockpos9, p_191123_3_.add(Rotation.CLOCKWISE_180)));
							}
							...
							if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, i1, k - 1)) {
								...
								p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a,
										"small_wall", blockpos10, p_191123_3_.add(Rotation.COUNTERCLOCKWISE_90)));
							}
							...
							if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, i1, k + 1)) {
								...
								p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a,
										"small_wall", blockpos11, p_191123_3_.add(Rotation.CLOCKWISE_90)));
							}
							...
							if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, i1 + 1, k)) {
								if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, i1, k - 1)) {
									...
									p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a,
											"small_wall_corner", blockpos12, p_191123_3_));
								}
								...
								if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, i1, k + 1)) {
									...
									p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a,
											"small_wall_corner", blockpos13, p_191123_3_.add(Rotation.CLOCKWISE_90)));
								}
							}
							...
							if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, i1 - 1, k)) {
								...
								if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, i1, k + 1)) {
									...
									p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a,
											"small_wall_corner", blockpos15, p_191123_3_.add(Rotation.CLOCKWISE_180)));
								}
							}
						}
					}
			...
			for (int l = 0; l < p_191123_4_.field_191150_c; ++l) {
				for (int j1 = 0; j1 < p_191123_4_.field_191149_b; ++j1) {
					BlockPos blockpos4 = p_191123_2_.offset(p_191123_3_.rotate(EnumFacing.SOUTH),
							8 + (l - this.field_191137_d) * 8);
					...
					if (WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j1, l) && !flag2) {
						if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j1 + 1, l)) {
							...
							if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j1, l + 1)) {
								...
								p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a,
										"roof_corner", blockpos2, p_191123_3_));
								...
								p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a,
										"roof_inner_corner", blockpos18, p_191123_3_));
							}

							if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j1, l - 1)) {
								p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a,
										"roof_corner", blockpos16, p_191123_3_.add(Rotation.COUNTERCLOCKWISE_90)));
							} else if (WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j1 + 1, l - 1)) {
								...
								p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a,
										"roof_inner_corner", blockpos19, p_191123_3_.add(Rotation.CLOCKWISE_90)));
							}
						}
						...
						if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j1 - 1, l)) {
							...
							if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j1, l + 1)) {
								...
								p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a,
										"roof_corner", blockpos20, p_191123_3_.add(Rotation.CLOCKWISE_90)));
							} else if (WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j1 - 1, l + 1)) {
								...
								p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a,
										"roof_inner_corner", blockpos21,
										p_191123_3_.add(Rotation.COUNTERCLOCKWISE_90)));
							}

							if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j1, l - 1)) {
								p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a,
										"roof_corner", blockpos17, p_191123_3_.add(Rotation.CLOCKWISE_180)));
							} else if (WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j1 - 1, l - 1)) {
								BlockPos blockpos22 = blockpos17.offset(p_191123_3_.rotate(EnumFacing.SOUTH), 1);
								p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a,
										"roof_inner_corner", blockpos22, p_191123_3_.add(Rotation.CLOCKWISE_180)));
							}
						}
					}
				}
		...
		private void func_191133_a(List<WoodlandMansionPieces.MansionTemplate> p_191133_1_,
				WoodlandMansionPieces.PlacementData p_191133_2_) {
			EnumFacing enumfacing = p_191133_2_.field_191138_a.rotate(EnumFacing.WEST);
			p_191133_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a, "entrance",
					p_191133_2_.field_191139_b.offset(enumfacing, 9), p_191133_2_.field_191138_a));
			p_191133_2_.field_191139_b = p_191133_2_.field_191139_b
					.offset(p_191133_2_.field_191138_a.rotate(EnumFacing.SOUTH), 16);
		}

		private void func_191131_b(List<WoodlandMansionPieces.MansionTemplate> p_191131_1_,
				WoodlandMansionPieces.PlacementData p_191131_2_) {
			p_191131_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a, p_191131_2_.field_191140_c,
					p_191131_2_.field_191139_b.offset(p_191131_2_.field_191138_a.rotate(EnumFacing.EAST), 7),
					p_191131_2_.field_191138_a));
			p_191131_2_.field_191139_b = p_191131_2_.field_191139_b
					.offset(p_191131_2_.field_191138_a.rotate(EnumFacing.SOUTH), 8);
		}

		private void func_191124_c(List<WoodlandMansionPieces.MansionTemplate> p_191124_1_,
				WoodlandMansionPieces.PlacementData p_191124_2_) {
			p_191124_2_.field_191139_b = p_191124_2_.field_191139_b
					.offset(p_191124_2_.field_191138_a.rotate(EnumFacing.SOUTH), -1);
			p_191124_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a, "wall_corner",
					p_191124_2_.field_191139_b, p_191124_2_.field_191138_a));
			p_191124_2_.field_191139_b = p_191124_2_.field_191139_b
					.offset(p_191124_2_.field_191138_a.rotate(EnumFacing.SOUTH), -7);
			p_191124_2_.field_191139_b = p_191124_2_.field_191139_b
					.offset(p_191124_2_.field_191138_a.rotate(EnumFacing.WEST), -6);
			p_191124_2_.field_191138_a = p_191124_2_.field_191138_a.add(Rotation.CLOCKWISE_90);
		}

		private void func_191126_d(List<WoodlandMansionPieces.MansionTemplate> p_191126_1_,
				WoodlandMansionPieces.PlacementData p_191126_2_) {
			p_191126_2_.field_191139_b = p_191126_2_.field_191139_b
					.offset(p_191126_2_.field_191138_a.rotate(EnumFacing.SOUTH), 6);
			p_191126_2_.field_191139_b = p_191126_2_.field_191139_b
					.offset(p_191126_2_.field_191138_a.rotate(EnumFacing.EAST), 8);
			p_191126_2_.field_191138_a = p_191126_2_.field_191138_a.add(Rotation.COUNTERCLOCKWISE_90);
		}

		private void func_191129_a(List<WoodlandMansionPieces.MansionTemplate> p_191129_1_, BlockPos p_191129_2_,
		...
		private void func_191132_a(List<WoodlandMansionPieces.MansionTemplate> p_191132_1_, BlockPos p_191132_2_,
			...
			if (p_191132_5_ == EnumFacing.EAST && p_191132_4_ == EnumFacing.SOUTH) {
				...
				p_191132_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a,
						p_191132_6_.func_191100_a(this.field_191135_b, p_191132_7_), blockpos13, p_191132_3_));
				...
				p_191132_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a,
						p_191132_6_.func_191100_a(this.field_191135_b, p_191132_7_), blockpos12, p_191132_3_,
						Mirror.LEFT_RIGHT));
				...
				p_191132_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a,
						p_191132_6_.func_191100_a(this.field_191135_b, p_191132_7_), blockpos11,
				...
				p_191132_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a,
						p_191132_6_.func_191100_a(this.field_191135_b, p_191132_7_), blockpos10, p_191132_3_,
						Mirror.FRONT_BACK));
				...
				p_191132_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a,
						p_191132_6_.func_191100_a(this.field_191135_b, p_191132_7_), blockpos9,
						p_191132_3_.add(Rotation.CLOCKWISE_90), Mirror.LEFT_RIGHT));
				...
				p_191132_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a,
						p_191132_6_.func_191100_a(this.field_191135_b, p_191132_7_), blockpos8,
				...
				p_191132_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a,
						p_191132_6_.func_191100_a(this.field_191135_b, p_191132_7_), blockpos7,
						p_191132_3_.add(Rotation.CLOCKWISE_90), Mirror.FRONT_BACK));
				...
				p_191132_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a,
						p_191132_6_.func_191100_a(this.field_191135_b, p_191132_7_), blockpos6,
				...
				p_191132_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a,
						p_191132_6_.func_191098_b(this.field_191135_b, p_191132_7_), blockpos5, p_191132_3_));
				...
				p_191132_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a,
						p_191132_6_.func_191098_b(this.field_191135_b, p_191132_7_), blockpos4,
						p_191132_3_.add(Rotation.CLOCKWISE_180)));
				...
				p_191132_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a,
						p_191132_6_.func_191098_b(this.field_191135_b, p_191132_7_), blockpos3,
						p_191132_3_.add(Rotation.CLOCKWISE_90)));
				...
				p_191132_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a,
						p_191132_6_.func_191098_b(this.field_191135_b, p_191132_7_), blockpos2,
						p_191132_3_.add(Rotation.COUNTERCLOCKWISE_90)));
				...
				p_191132_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a,
						p_191132_6_.func_191102_c(this.field_191135_b), blockpos1,
						p_191132_3_.add(Rotation.CLOCKWISE_90)));
				...
				p_191132_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a,
						p_191132_6_.func_191102_c(this.field_191135_b), blockpos, p_191132_3_));
			}
		}

		private void func_191127_a(List<WoodlandMansionPieces.MansionTemplate> p_191127_1_, BlockPos p_191127_2_,
			...
			p_191127_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a,
					p_191127_6_.func_191101_d(this.field_191135_b), blockpos, rotation, mirror));
		}

		private void func_191128_a(List<WoodlandMansionPieces.MansionTemplate> p_191128_1_, BlockPos p_191128_2_,
			...
			p_191128_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a,
					p_191128_4_.func_191103_e(this.field_191135_b), blockpos, p_191128_3_, Mirror.NONE));
		}
	}
	...
	static class SimpleGrid {
		...
		public void func_191144_a(int p_191144_1_, int p_191144_2_, int p_191144_3_) {
			if (p_191144_1_ >= 0 && p_191144_1_ < this.field_191149_b && p_191144_2_ >= 0
					&& p_191144_2_ < this.field_191150_c) {
		...
		public int func_191145_a(int p_191145_1_, int p_191145_2_) {
			return p_191145_1_ >= 0 && p_191145_1_ < this.field_191149_b && p_191145_2_ >= 0
					&& p_191145_2_ < this.field_191150_c ? this.field_191148_a[p_191145_1_][p_191145_2_]
							: this.field_191151_d;
		}
		...
		public boolean func_191147_b(int p_191147_1_, int p_191147_2_, int p_191147_3_) {
			return this.func_191145_a(p_191147_1_ - 1, p_191147_2_) == p_191147_3_
					|| this.func_191145_a(p_191147_1_ + 1, p_191147_2_) == p_191147_3_
					|| this.func_191145_a(p_191147_1_, p_191147_2_ + 1) == p_191147_3_
					|| this.func_191145_a(p_191147_1_, p_191147_2_ - 1) == p_191147_3_;
		}
	}
