...
public class MapGenVillage extends MapGenStructure {
	public static final List<Biome> VILLAGE_SPAWN_BIOMES = Arrays.<Biome>asList(Biomes.PLAINS, Biomes.DESERT,
			Biomes.SAVANNA, Biomes.TAIGA);
	...
	protected boolean canSpawnStructureAtCoords(int chunkX, int chunkZ) {
		...
		if (i == k && j == l) {
			boolean flag = this.worldObj.getBiomeProvider().areBiomesViable(i * 16 + 8, j * 16 + 8, 0,
