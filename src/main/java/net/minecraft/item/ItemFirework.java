...
public class ItemFirework extends Item {
	...
	public EnumActionResult onItemUse(EntityPlayer stack, World playerIn, BlockPos worldIn, EnumHand pos,
		...
		if (!playerIn.isRemote) {
			...
			EntityFireworkRocket entityfireworkrocket = new EntityFireworkRocket(playerIn,
					(double) ((float) worldIn.getX() + facing), (double) ((float) worldIn.getY() + hitX),
					(double) ((float) worldIn.getZ() + hitY), itemstack);
