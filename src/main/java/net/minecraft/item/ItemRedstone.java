...
public class ItemRedstone extends Item {
	...
	public EnumActionResult onItemUse(EntityPlayer stack, World playerIn, BlockPos worldIn, EnumHand pos,
		...
		if (stack.canPlayerEdit(blockpos, hand, itemstack) && playerIn
				.func_190527_a(playerIn.getBlockState(blockpos).getBlock(), blockpos, false, hand, (Entity) null)
				&& Blocks.REDSTONE_WIRE.canPlaceBlockAt(playerIn, blockpos)) {
