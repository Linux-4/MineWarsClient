...
public class ItemMap extends ItemMapBase {
	...
	public static ItemStack func_190906_a(World p_190906_0_, double p_190906_1_, double p_190906_3_, byte p_190906_5_,
			boolean p_190906_6_, boolean p_190906_7_) {
												...
												label175: {
													while (true) {
														...
														blockpos$mutableblockpos.setPos(
																(chunk.xPosition << 4) + i4 + i3, k4,
																(chunk.zPosition << 4) + j4 + j3);

														if (iblockstate.getMapColor(worldIn,
																blockpos$mutableblockpos) != MapColor.AIR || k4 <= 0) {
															break;
														}
													}
													...
													if (k4 > 0 && iblockstate.getMaterial().isLiquid()) {
														...
														while (true) {
															IBlockState iblockstate1 = chunk.getBlockState(i4 + i3,
																	l4--, j4 + j3);
															++k3;
		...
		if (p_190905_1_.getItem() == Items.FILLED_MAP) {
			...
			if (mapdata != null) {
				if (p_190905_0_.provider.getDimensionType().getId() == mapdata.dimension) {
					...
					Biome[] abiome = p_190905_0_.getBiomeProvider().getBiomes((Biome[]) null, (j / i - 64) * i,
							(k / i - 64) * i, 128 * i, 128 * i, false);
