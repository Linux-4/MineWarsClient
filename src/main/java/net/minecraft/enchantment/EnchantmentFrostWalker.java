				...
				if (blockpos$mutableblockpos1.distanceSqToCenter(living.posX, living.posY,
					...
					if (iblockstate.getMaterial() == Material.AIR) {
						...
						if (iblockstate1.getMaterial() == Material.WATER
								...
								&& worldIn.func_190527_a(Blocks.FROSTED_ICE, blockpos$mutableblockpos1, false,
										EnumFacing.DOWN, (Entity) null)) {
							worldIn.setBlockState(blockpos$mutableblockpos1, Blocks.FROSTED_ICE.getDefaultState());
							worldIn.scheduleUpdate(blockpos$mutableblockpos1.toImmutable(), Blocks.FROSTED_ICE,
