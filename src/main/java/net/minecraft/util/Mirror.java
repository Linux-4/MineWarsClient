...
public enum Mirror {
	...
	/**
	 * Mirrors the given rotation like specified by this mirror. rotations start at
	 * 0 and go up to rotationCount-1. 0 is front, rotationCount/2 is back.
	 */
	...
	/**
	 * Determines the rotation that is equivalent to this mirror if the rotating
	 * object faces in the given direction
	 */
	public Rotation toRotation(EnumFacing facing) {
		...
		return (this != LEFT_RIGHT || enumfacing$axis != EnumFacing.Axis.Z)
				&& (this != FRONT_BACK || enumfacing$axis != EnumFacing.Axis.X) ? Rotation.NONE
