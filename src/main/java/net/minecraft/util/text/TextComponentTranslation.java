...
public class TextComponentTranslation extends TextComponentBase {
	...
	public Iterator<ITextComponent> iterator() {
		...
		return Iterators.<ITextComponent>concat(createDeepCopyIterator(this.children),
	...
	public boolean equals(Object p_equals_1_) {
		if (this == p_equals_1_) {
			...
			return Arrays.equals(this.formatArgs, textcomponenttranslation.formatArgs)
					&& this.key.equals(textcomponenttranslation.key) && super.equals(p_equals_1_);
		}
	}
	...
	public String toString() {
		return "TranslatableComponent{key='" + this.key + '\'' + ", args=" + Arrays.toString(this.formatArgs)
				+ ", siblings=" + this.siblings + ", style=" + this.getStyle() + '}';
	}
