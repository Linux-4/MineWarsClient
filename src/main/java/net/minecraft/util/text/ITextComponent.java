			...
			if (p_deserialize_1_.isJsonPrimitive()) {
				...
				if (p_deserialize_1_.isJsonArray()) {
					...
					for (JsonElement jsonelement : jsonarray1) {
						ITextComponent itextcomponent2 = this.deserialize(jsonelement, jsonelement.getClass(),
								p_deserialize_3_);
				...
				if (jsonobject.has("text")) {
					...
					itextcomponent = new TextComponentScore(JsonUtils.getString(jsonobject1, "name"),
