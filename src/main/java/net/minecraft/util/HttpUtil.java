...
public class HttpUtil {
	public static final ListeningExecutorService DOWNLOADER_EXECUTOR = MoreExecutors.listeningDecorator(Executors
			...
			public void run() {
				...
				try {
					try {
						...
						if (p_180192_4_ != null) {
							p_180192_4_.displayLoadingString(I18n.translateToLocalFormatted("resourcepack.progress",
						...
						if (saveFile.exists()) {
							...
							HttpUtil.LOGGER.warn(
									"Deleting {} as it does not match what we currently have ({} vs our {}).", saveFile,
