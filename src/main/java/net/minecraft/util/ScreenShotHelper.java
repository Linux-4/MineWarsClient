...
public class ScreenShotHelper {
	 ...
	 * generate a time-stamped name). Returns an ITextComponent indicating the
	 * success/failure of the saving.
	 */
	public static ITextComponent saveScreenshot(File gameDirectory, @Nullable String screenshotName, int width,
		...
		try {
			...
			if (object != null) {
				ITextComponent itextcomponent1 = (ITextComponent) Reflector.call(object,
						Reflector.ScreenshotEvent_getResultMessage);
	...
	private static void resize(int p_resize_0_, int p_resize_1_) {
		...
		if (minecraft.currentScreen != null) {
			ScaledResolution scaledresolution = new ScaledResolution(minecraft);
			minecraft.currentScreen.onResize(minecraft, scaledresolution.getScaledWidth(),
