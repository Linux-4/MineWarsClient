...
public class BlockVine extends Block {
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
		...
		return state.withProperty(UP, Boolean.valueOf(worldIn.getBlockState(blockpos).func_193401_d(worldIn, blockpos,
	...
	public boolean func_193395_a(World p_193395_1_, BlockPos p_193395_2_, EnumFacing p_193395_3_) {
		...
		return this.func_193396_c(p_193395_1_, p_193395_2_.offset(p_193395_3_.getOpposite()), p_193395_3_)
				&& (block == Blocks.AIR || block == Blocks.VINE
						|| this.func_193396_c(p_193395_1_, p_193395_2_.up(), EnumFacing.UP));
	}
	...
	private boolean func_193396_c(World p_193396_1_, BlockPos p_193396_2_, EnumFacing p_193396_3_) {
		...
		return iblockstate.func_193401_d(p_193396_1_, p_193396_2_, p_193396_3_) == BlockFaceShape.SOLID
				&& !func_193397_e(iblockstate.getBlock());
	}

	protected static boolean func_193397_e(Block p_193397_0_) {
		return p_193397_0_ instanceof BlockShulkerBox || p_193397_0_ == Blocks.BEACON || p_193397_0_ == Blocks.CAULDRON
				|| p_193397_0_ == Blocks.GLASS || p_193397_0_ == Blocks.STAINED_GLASS || p_193397_0_ == Blocks.PISTON
				|| p_193397_0_ == Blocks.STICKY_PISTON || p_193397_0_ == Blocks.PISTON_HEAD
	...
	private boolean recheckGrownSides(World worldIn, BlockPos pos, IBlockState state) {
		...
		for (EnumFacing enumfacing : EnumFacing.Plane.HORIZONTAL) {
			...
			if (((Boolean) state.getValue(propertybool)).booleanValue()
					&& !this.func_193395_a(worldIn, pos, enumfacing.getOpposite())) {
				...
				if (enumfacing1 == EnumFacing.UP && pos.getY() < 255 && worldIn.isAirBlock(blockpos2)) {
					...
					for (EnumFacing enumfacing2 : EnumFacing.Plane.HORIZONTAL) {
						if (rand.nextBoolean() && this.func_193395_a(worldIn, blockpos2, enumfacing2.getOpposite())) {
							iblockstate2 = iblockstate2.withProperty(getPropertyFor(enumfacing2),
					...
					if (!flag) {
						...
						if (block1.blockMaterial == Material.AIR) {
							...
							if (flag1 && this.func_193395_a(worldIn, blockpos.offset(enumfacing3), enumfacing3)) {
								worldIn.setBlockState(blockpos4, this.getDefaultState()
										.withProperty(getPropertyFor(enumfacing3), Boolean.valueOf(true)), 2);
							} else if (flag2
									&& this.func_193395_a(worldIn, blockpos1.offset(enumfacing4), enumfacing4)) {
								worldIn.setBlockState(blockpos4, this.getDefaultState()
										.withProperty(getPropertyFor(enumfacing4), Boolean.valueOf(true)), 2);
							} else if (flag1 && worldIn.isAirBlock(blockpos)
									&& this.func_193395_a(worldIn, blockpos, enumfacing1)) {
								worldIn.setBlockState(blockpos, this.getDefaultState().withProperty(
									...
									&& this.func_193395_a(worldIn, blockpos1, enumfacing1)) {
								worldIn.setBlockState(blockpos1, this.getDefaultState().withProperty(
										getPropertyFor(enumfacing1.getOpposite()), Boolean.valueOf(true)), 2);
							}
						} else if (iblockstate3.func_193401_d(worldIn, blockpos4,
								enumfacing1) == BlockFaceShape.SOLID) {
