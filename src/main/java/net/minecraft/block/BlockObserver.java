...
public class BlockObserver extends BlockDirectional {
	...
	public BlockObserver() {
		...
		this.setDefaultState(this.blockState.getBaseState().withProperty(FACING, EnumFacing.SOUTH)
				.withProperty(field_190963_a, Boolean.valueOf(false)));
	...
	public void func_190962_b(IBlockState p_190962_1_, World p_190962_2_, BlockPos p_190962_3_, Block p_190962_4_,
			BlockPos p_190962_5_) {
		if (!p_190962_2_.isRemote
				&& p_190962_3_.offset((EnumFacing) p_190962_1_.getValue(FACING)).equals(p_190962_5_)) {
	...
	public int getWeakPower(IBlockState blockState, IBlockAccess blockAccess, BlockPos pos, EnumFacing side) {
		return ((Boolean) blockState.getValue(field_190963_a)).booleanValue() && blockState.getValue(FACING) == side
				? 15
				: 0;
	}
