...
public interface IBlockProperties {
	...
	/**
	 * Returns the blockstate mirrored in the given way. If inapplicable, returns
	 * itself.
	 */
	...
	void addCollisionBoxToList(World worldIn, BlockPos pos, AxisAlignedBB p_185908_3_, List<AxisAlignedBB> p_185908_4_,
			Entity p_185908_5_, boolean p_185908_6_);
