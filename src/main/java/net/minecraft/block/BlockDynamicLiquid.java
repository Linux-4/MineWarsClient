...
public class BlockDynamicLiquid extends BlockLiquid {
	...
	private boolean isBlocked(World worldIn, BlockPos pos, IBlockState state) {
		...
		if (!(block instanceof BlockDoor) && block != Blocks.STANDING_SIGN && block != Blocks.LADDER
				&& block != Blocks.REEDS) {
			return block.blockMaterial != Material.PORTAL && block.blockMaterial != Material.STRUCTURE_VOID
