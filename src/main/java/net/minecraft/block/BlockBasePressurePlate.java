...
public abstract class BlockBasePressurePlate extends Block {
	...
	protected static final AxisAlignedBB PRESSED_AABB = new AxisAlignedBB(0.0625D, 0.0D, 0.0625D, 0.9375D, 0.03125D,
			0.9375D);
	protected static final AxisAlignedBB UNPRESSED_AABB = new AxisAlignedBB(0.0625D, 0.0D, 0.0625D, 0.9375D, 0.0625D,
			0.9375D);

	/**
	 * This bounding box is used to check for entities in a certain area and then
