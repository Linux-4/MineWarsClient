...
public abstract class EntityAgeable extends EntityCreature {
	private static final DataParameter<Boolean> BABY = EntityDataManager.<Boolean>createKey(EntityAgeable.class,
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand) {
		...
		if (itemstack.getItem() == Items.SPAWN_EGG) {
			if (!this.world.isRemote) {
				Class<? extends Entity> oclass = (Class) EntityList.field_191308_b
						.getObject(ItemMonsterPlacer.func_190908_h(itemstack));
	...
	protected boolean func_190669_a(ItemStack p_190669_1_, Class<? extends Entity> p_190669_2_) {
		if (p_190669_1_.getItem() != Items.SPAWN_EGG) {
			...
			Class<? extends Entity> oclass = (Class) EntityList.field_191308_b
					.getObject(ItemMonsterPlacer.func_190908_h(p_190669_1_));
