...
public class EntityAIFollowOwner extends EntityAIBase {
	...
	public EntityAIFollowOwner(EntityTameable thePetIn, double followSpeedIn, float minDistIn, float maxDistIn) {
		...
		if (!(thePetIn.getNavigator() instanceof PathNavigateGround)
				&& !(thePetIn.getNavigator() instanceof PathNavigateFlying)) {
	...
	protected boolean func_192381_a(int p_192381_1_, int p_192381_2_, int p_192381_3_, int p_192381_4_,
		...
		return iblockstate.func_193401_d(this.theWorld, blockpos, EnumFacing.DOWN) == BlockFaceShape.SOLID
				&& iblockstate.canEntitySpawn(this.thePet) && this.theWorld.isAirBlock(blockpos.up())
