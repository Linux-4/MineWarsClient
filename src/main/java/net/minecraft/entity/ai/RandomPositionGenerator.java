...
public class RandomPositionGenerator {
	...
	@Nullable
	private static Vec3d func_191379_a(EntityCreature p_191379_0_, int p_191379_1_, int p_191379_2_,
		...
		if (p_191379_0_.hasHome()) {
			double d0 = p_191379_0_.getHomePosition().distanceSq((double) MathHelper.floor(p_191379_0_.posX),
					(double) MathHelper.floor(p_191379_0_.posY), (double) MathHelper.floor(p_191379_0_.posZ)) + 4.0D;
		...
		for (int k = 0; k < 10; ++k) {
			...
			if (p_191379_3_ == null || (double) l * p_191379_3_.xCoord + (double) j1 * p_191379_3_.zCoord >= 0.0D) {
				...
				BlockPos blockpos1 = new BlockPos((double) l + p_191379_0_.posX, (double) i1 + p_191379_0_.posY,
		...
		if (flag1) {
			return new Vec3d((double) k1 + p_191379_0_.posX, (double) i + p_191379_0_.posY,
