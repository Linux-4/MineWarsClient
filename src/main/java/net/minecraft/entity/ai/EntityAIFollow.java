...
public class EntityAIFollow extends EntityAIBase {
	...
	public boolean shouldExecute() {
		List<EntityLiving> list = this.field_192372_a.world.<EntityLiving>getEntitiesWithinAABB(EntityLiving.class,
				this.field_192372_a.getEntityBoundingBox().expandXyz((double) this.field_192380_i),
				this.field_192373_b);
	...
	public boolean continueExecuting() {
		return this.field_192374_c != null && !this.field_192376_e.noPath() && this.field_192372_a
				.getDistanceSqToEntity(this.field_192374_c) > (double) (this.field_192378_g * this.field_192378_g);
	}
	...
	public void updateTask() {
		if (this.field_192374_c != null && !this.field_192372_a.getLeashed()) {
			this.field_192372_a.getLookHelper().setLookPositionWithEntity(this.field_192374_c, 10.0F,
					(float) this.field_192372_a.getVerticalFaceSpeed());
			...
			if (--this.field_192377_f <= 0) {
				...
				if (d3 > (double) (this.field_192378_g * this.field_192378_g)) {
					...
					if (d3 <= (double) this.field_192378_g || entitylookhelper.getLookPosX() == this.field_192372_a.posX
							&& entitylookhelper.getLookPosY() == this.field_192372_a.posY
							&& entitylookhelper.getLookPosZ() == this.field_192372_a.posZ) {
						double d4 = this.field_192374_c.posX - this.field_192372_a.posX;
						double d5 = this.field_192374_c.posZ - this.field_192372_a.posZ;
						this.field_192376_e.tryMoveToXYZ(this.field_192372_a.posX - d4, this.field_192372_a.posY,
								this.field_192372_a.posZ - d5, this.field_192375_d);
					}
				}
			}
		}
