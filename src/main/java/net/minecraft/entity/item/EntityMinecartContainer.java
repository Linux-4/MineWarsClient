...
public abstract class EntityMinecartContainer extends EntityMinecart implements ILockableContainer, ILootContainer {
	private NonNullList<ItemStack> minecartContainerItems = NonNullList.<ItemStack>func_191197_a(36,
	...
	protected void readEntityFromNBT(NBTTagCompound compound) {
		...
		this.minecartContainerItems = NonNullList.<ItemStack>func_191197_a(this.getSizeInventory(),
				ItemStack.field_190927_a);
