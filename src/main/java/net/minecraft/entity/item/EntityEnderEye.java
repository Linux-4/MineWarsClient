	...
	public void onUpdate() {
		...
		if (this.isInWater()) {
			...
			this.world.spawnParticle(EnumParticleTypes.PORTAL,
					...
					this.posZ - this.motionZ * 0.25D + this.rand.nextDouble() * 0.6D - 0.3D, this.motionX, this.motionY,
					this.motionZ);
		}
		...
		if (!this.world.isRemote) {
			...
			if (this.despawnTimer > 80 && !this.world.isRemote) {
				...
				if (this.shatterOrDrop) {
					this.world.spawnEntityInWorld(new EntityItem(this.world, this.posX, this.posY, this.posZ,
