...
public class EntityList {
	...
	public static void init() {
		...
		func_191303_a(40, "commandblock_minecart", EntityMinecartCommandBlock.class,
	...
	private static void func_191303_a(int p_191303_0_, String p_191303_1_, Class<? extends Entity> p_191303_2_,
			String p_191303_3_) {
		try {
			p_191303_2_.getConstructor(World.class);
		} catch (NoSuchMethodException var5) {
			throw new RuntimeException(
					"Invalid class " + p_191303_2_ + " no constructor taking " + World.class.getName());
		}
