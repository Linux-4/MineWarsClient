	...
	public void doLocalUpdate() {
		...
		if (entitylivingbase != null) {
			if (this.scanningTime > 25) {
				...
				Vec3d vec3d = (new Vec3d(entitylivingbase.posX - this.dragon.posX, 0.0D,
						entitylivingbase.posZ - this.dragon.posZ)).normalize();
				Vec3d vec3d1 = (new Vec3d((double) MathHelper.sin(this.dragon.rotationYaw * 0.017453292F), 0.0D,
				...
				if (f1 < 0.0F || f1 > 10.0F) {
					...
					double d2 = MathHelper.clamp(MathHelper.wrapDegrees(
			...
			if (entitylivingbase != null) {
				...
				((PhaseChargingPlayer) this.dragon.getPhaseManager().getPhase(PhaseList.CHARGING_PLAYER))
