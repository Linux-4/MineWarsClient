...
public abstract class EntityHanging extends Entity {
	...
	public void moveEntity(MoverType x, double p_70091_2_, double p_70091_4_, double p_70091_6_) {
		if (!this.world.isRemote && !this.isDead
				&& p_70091_2_ * p_70091_2_ + p_70091_4_ * p_70091_4_ + p_70091_6_ * p_70091_6_ > 0.0D) {
			this.setDead();
			this.onBroken((Entity) null);
		}
	}
	...
	public void readEntityFromNBT(NBTTagCompound compound) {
		this.hangingPosition = new BlockPos(compound.getInteger("TileX"), compound.getInteger("TileY"),
	...
	public EntityItem entityDropItem(ItemStack stack, float offsetY) {
		EntityItem entityitem = new EntityItem(this.world,
				...
				this.posZ + (double) ((float) this.facingDirection.getFrontOffsetZ() * 0.15F), stack);
