...
public class EntityWolf extends EntityTameable {
	...
	public float getTailRotation() {
		if (this.isAngry()) {
			...
			return this.isTamed()
					? (0.55F - (this.getMaxHealth() - ((Float) this.dataManager.get(DATA_HEALTH_ID)).floatValue())
							* 0.02F) * (float) Math.PI
					: ((float) Math.PI / 5F);
		}
	}
	...
	public boolean shouldAttackEntity(EntityLivingBase p_142018_1_, EntityLivingBase p_142018_2_) {
		if (!(p_142018_1_ instanceof EntityCreeper) && !(p_142018_1_ instanceof EntityGhast)) {
			...
			if (p_142018_1_ instanceof EntityPlayer && p_142018_2_ instanceof EntityPlayer
	...
	class AIAvoidEntity<T extends Entity> extends EntityAIAvoidEntity<T> {
		...
		public AIAvoidEntity(EntityWolf p_i47251_2_, Class<T> p_i47251_3_, float p_i47251_4_, double p_i47251_5_,
				double p_i47251_7_) {
