...
public class EntityVillager extends EntityAgeable implements INpc, IMerchant {
	...
	private static final DataParameter<Integer> PROFESSION = EntityDataManager.<Integer>createKey(EntityVillager.class,
	...
	private static final EntityVillager.ITradeList[][][][] DEFAULT_TRADE_LIST_MAP = new EntityVillager.ITradeList[][][][] {
			{ { { new EntityVillager.EmeraldForItems(Items.WHEAT, new EntityVillager.PriceInfo(18, 22)),
					...
					{ { new EntityVillager.EmeraldForItems(Item.getItemFromBlock(Blocks.WOOL),
							...
							{ new EntityVillager.ListItemForEmeralds(new ItemStack(Item.getItemFromBlock(Blocks.WOOL)),
			...
			{ { { new EntityVillager.EmeraldForItems(Items.PAPER, new EntityVillager.PriceInfo(24, 36)),
					...
					{ { new EntityVillager.EmeraldForItems(Items.PAPER, new EntityVillager.PriceInfo(24, 36)) },
							...
							{ new EntityVillager.TreasureMapForEmeralds(new EntityVillager.PriceInfo(12, 20),
									"Monument", MapDecoration.Type.MONUMENT),
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand) {
		...
		if (flag) {
			...
			return true;
		} else if (!this.func_190669_a(itemstack, this.getClass()) && this.isEntityAlive() && !this.isTrading()
				&& !this.isChild()) {
	...
	public static void registerFixesVillager(DataFixer fixer) {
		...
		fixer.registerWalker(FixTypes.ENTITY, new IDataWalker() {
			public NBTTagCompound process(IDataFixer fixer, NBTTagCompound compound, int versionIn) {
				if (EntityList.func_191306_a(EntityVillager.class)
	...
	public void useRecipe(MerchantRecipe recipe) {
		...
		if (this.buyingPlayer instanceof EntityPlayerMP) {
			CriteriaTriggers.field_192138_r.func_192234_a((EntityPlayerMP) this.buyingPlayer, this,
	...
	public void verifySellingItem(ItemStack stack) {
		if (!this.world.isRemote && this.livingSoundTime > -this.getTalkInterval() + 20) {
			this.livingSoundTime = -this.getTalkInterval();
			this.playSound(stack.func_190926_b() ? SoundEvents.ENTITY_VILLAGER_NO : SoundEvents.ENTITY_VILLAGER_YES,
	...
	public IEntityLivingData func_190672_a(DifficultyInstance p_190672_1_, @Nullable IEntityLivingData p_190672_2_,
			boolean p_190672_3_) {
	...
	public EntityVillager createChild(EntityAgeable ageable) {
		...
		entityvillager.onInitialSpawn(this.world.getDifficultyForLocation(new BlockPos(entityvillager)),
	...
	public void onStruckByLightning(EntityLightningBolt lightningBolt) {
		if (!this.world.isRemote && !this.isDead) {
			...
			entitywitch.onInitialSpawn(this.world.getDifficultyForLocation(new BlockPos(entitywitch)),
					(IEntityLivingData) null);
	...
	private boolean hasEnoughItems(int multiplier) {
		...
		for (int i = 0; i < this.villagerInventory.getSizeInventory(); ++i) {
			...
			if (!itemstack.func_190926_b()) {
				if (itemstack.getItem() == Items.BREAD && itemstack.func_190916_E() >= 3 * multiplier
						|| itemstack.getItem() == Items.POTATO && itemstack.func_190916_E() >= 12 * multiplier
						|| itemstack.getItem() == Items.CARROT && itemstack.func_190916_E() >= 12 * multiplier
						|| itemstack.getItem() == Items.BEETROOT && itemstack.func_190916_E() >= 12 * multiplier) {
					return true;
				}
	...
	public boolean isFarmItemInInventory() {
		for (int i = 0; i < this.villagerInventory.getSizeInventory(); ++i) {
			...
			if (!itemstack.func_190926_b()
					&& (itemstack.getItem() == Items.WHEAT_SEEDS || itemstack.getItem() == Items.POTATO
	...
	static class ItemAndEmeraldToItem implements EntityVillager.ITradeList {
		...
		public void func_190888_a(IMerchant p_190888_1_, MerchantRecipeList p_190888_2_, Random p_190888_3_) {
			...
			p_190888_2_.add(new MerchantRecipe(
	...
	static class ListEnchantedItemForEmeralds implements EntityVillager.ITradeList {
		...
		public void func_190888_a(IMerchant p_190888_1_, MerchantRecipeList p_190888_2_, Random p_190888_3_) {
			...
			ItemStack itemstack1 = EnchantmentHelper.addRandomEnchantment(p_190888_3_,
					...
					5 + p_190888_3_.nextInt(15), false);
		...
		public PriceInfo(int p_i45810_1_, int p_i45810_2_) {
			...
			if (p_i45810_2_ < p_i45810_1_) {
				EntityVillager.field_190674_bx.warn("PriceRange({}, {}) invalid, {} smaller than {}",
						Integer.valueOf(p_i45810_1_), Integer.valueOf(p_i45810_2_), Integer.valueOf(p_i45810_2_),
	...
	static class TreasureMapForEmeralds implements EntityVillager.ITradeList {
		...
		public void func_190888_a(IMerchant p_190888_1_, MerchantRecipeList p_190888_2_, Random p_190888_3_) {
			...
			if (blockpos != null) {
				ItemStack itemstack = ItemMap.func_190906_a(world, (double) blockpos.getX(), (double) blockpos.getZ(),
						(byte) 2, true, true);
