...
public abstract class EntitySpellcasterIllager extends AbstractIllager {
	private static final DataParameter<Byte> field_193088_c = EntityDataManager
	...
	public AbstractIllager.IllagerArmPose func_193077_p() {
		return this.func_193082_dl() ? AbstractIllager.IllagerArmPose.SPELLCASTING
	...
	protected EntitySpellcasterIllager.SpellType func_193083_dm() {
		return !this.world.isRemote ? this.field_193089_bx
				: EntitySpellcasterIllager.SpellType
						.func_193337_a(((Byte) this.dataManager.get(field_193088_c)).byteValue());
	}
	...
	public void onUpdate() {
		...
		if (this.world.isRemote && this.func_193082_dl()) {
			...
			this.world.spawnParticle(EnumParticleTypes.SPELL_MOB, this.posX + (double) f1 * 0.6D, this.posY + 1.8D,
					this.posZ + (double) f2 * 0.6D, d0, d1, d2);
			this.world.spawnParticle(EnumParticleTypes.SPELL_MOB, this.posX - (double) f1 * 0.6D, this.posY + 1.8D,
					this.posZ - (double) f2 * 0.6D, d0, d1, d2);
		}
	}
	...
	public class AICastingApell extends EntityAIBase {
		...
		public void updateTask() {
			if (EntitySpellcasterIllager.this.getAttackTarget() != null) {
				EntitySpellcasterIllager.this.getLookHelper().setLookPositionWithEntity(
