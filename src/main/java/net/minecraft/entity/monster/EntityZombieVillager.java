...
public class EntityZombieVillager extends EntityZombie {
	...
	private static final DataParameter<Integer> field_190739_c = EntityDataManager
	...
	protected void func_190738_dp() {
		...
		entityvillager.func_190672_a(this.world.getDifficultyForLocation(new BlockPos(entityvillager)),
		...
		this.world.playEvent((EntityPlayer) null, 1027, new BlockPos((int) this.posX, (int) this.posY, (int) this.posZ),
				0);
	}
