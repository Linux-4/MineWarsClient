...
public class EntityElderGuardian extends EntityGuardian {
	...
	protected void updateAITasks() {
		...
		if ((this.ticksExisted + this.getEntityId()) % 1200 == 0) {
			...
			List<EntityPlayerMP> list = this.world.<EntityPlayerMP>getPlayers(EntityPlayerMP.class,
					new Predicate<EntityPlayerMP>() {
						public boolean apply(@Nullable EntityPlayerMP p_apply_1_) {
							return EntityElderGuardian.this.getDistanceSqToEntity(p_apply_1_) < 2500.0D
