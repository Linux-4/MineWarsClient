...
public class EntityGuardian extends EntityMob {
	private static final DataParameter<Boolean> field_190766_bz = EntityDataManager
		...
		if (this.world.isRemote) {
			...
			if (!this.isInWater()) {
				...
				if (this.motionY > 0.0D && this.clientSideTouchedGround && !this.isSilent()) {
					this.world.playSound(this.posX, this.posY, this.posZ, this.func_190765_dj(),
	...
	static class AIGuardianAttack extends EntityAIBase {
		...
		public boolean continueExecuting() {
			return super.continueExecuting() && (this.field_190881_c
