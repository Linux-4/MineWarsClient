...
public class EntityIllusionIllager extends EntitySpellcasterIllager implements IRangedAttackMob {
	...
	protected void initEntityAI() {
		...
		this.targetTasks.addTask(3,
				(new EntityAINearestAttackableTarget(this, EntityIronGolem.class, false)).func_190882_b(300));
	}
		...
		if (this.world.isRemote && this.isInvisible()) {
			...
			if (this.hurtTime != 1 && this.ticksExisted % 1200 != 0) {
				...
				for (int j = 0; j < 4; ++j) {
					...
					this.field_193100_bx[1][j] = new Vec3d((double) (-6.0F + (float) this.rand.nextInt(13)) * 0.5D,
				...
				this.world.playSound(this.posX, this.posY, this.posZ, SoundEvents.field_193788_dg,
	...
	public AbstractIllager.IllagerArmPose func_193077_p() {
		if (this.func_193082_dl()) {
			...
			return this.func_193096_dj() ? AbstractIllager.IllagerArmPose.BOW_AND_ARROW
