...
public class EntityEnderman extends EntityMob {
	...
	private static final DataParameter<Boolean> SCREAMING = EntityDataManager.<Boolean>createKey(EntityEnderman.class,
	...
	static class AITakeBlock extends EntityAIBase {
		...
		public void updateTask() {
			...
			RayTraceResult raytraceresult = world.rayTraceBlocks(
					new Vec3d((double) ((float) MathHelper.floor(this.enderman.posX) + 0.5F),
							(double) ((float) j + 0.5F),
