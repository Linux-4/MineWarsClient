				...
				if (entitylivingbase.canBeHitWithPotion()) {
					...
					if (d0 < 16.0D) {
						...
						for (PotionEffect potioneffect : p_190543_2_) {
							...
							if (potion.isInstant()) {
								potion.affectEntity(this, this.getThrower(), entitylivingbase,
								...
								if (i > 20) {
									entitylivingbase
											.addPotionEffect(new PotionEffect(potion, i, potioneffect.getAmplifier(),
