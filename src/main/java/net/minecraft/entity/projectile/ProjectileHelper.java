...
public final class ProjectileHelper {
	public static RayTraceResult forwardsRaycast(Entity p_188802_0_, boolean includeEntities, boolean p_188802_2_,
		...
		if (includeEntities) {
			...
			List<Entity> list = world.getEntitiesWithinAABBExcludingEntity(p_188802_0_,
					p_188802_0_.getEntityBoundingBox().addCoord(d3, d4, d5).expandXyz(1.0D));
			double d6 = 0.0D;

			for (int i = 0; i < list.size(); ++i) {
				Entity entity1 = list.get(i);

				if (entity1.canBeCollidedWith() && (p_188802_2_ || !entity1.isEntityEqual(excludedEntity))
						&& !entity1.noClip) {
	...
	public static final void rotateTowardsMovement(Entity p_188803_0_, float p_188803_1_) {
		...
		for (p_188803_0_.rotationPitch = (float) (MathHelper.atan2((double) f, d1) * (180D / Math.PI))
