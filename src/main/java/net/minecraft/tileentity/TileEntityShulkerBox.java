...
public class TileEntityShulkerBox extends TileEntityLockableLoot implements ITickable, ISidedInventory {
	...
	public void update() {
		...
		if (this.field_190599_i == TileEntityShulkerBox.AnimationStatus.OPENING
	...
	public AxisAlignedBB func_190587_b(EnumFacing p_190587_1_) {
		return Block.FULL_BLOCK_AABB.addCoord(
				(double) (0.5F * this.func_190585_a(1.0F) * (float) p_190587_1_.getFrontOffsetX()),
				(double) (0.5F * this.func_190585_a(1.0F) * (float) p_190587_1_.getFrontOffsetY()),
				(double) (0.5F * this.func_190585_a(1.0F) * (float) p_190587_1_.getFrontOffsetZ()));
	}

	private AxisAlignedBB func_190588_c(EnumFacing p_190588_1_) {
		EnumFacing enumfacing = p_190588_1_.getOpposite();
		return this.func_190587_b(p_190588_1_).func_191195_a((double) enumfacing.getFrontOffsetX(),
				(double) enumfacing.getFrontOffsetY(), (double) enumfacing.getFrontOffsetZ());
	}
			...
			if (!list.isEmpty()) {
				for (int i = 0; i < list.size(); ++i) {
					...
					if (entity.getPushReaction() != EnumPushReaction.IGNORE) {
						...
						entity.moveEntity(MoverType.SHULKER_BOX, d0 * (double) enumfacing.getFrontOffsetX(),
								d1 * (double) enumfacing.getFrontOffsetY(), d2 * (double) enumfacing.getFrontOffsetZ());
					}
				}
			}
		}
	...
	public void openInventory(EntityPlayer player) {
		if (!player.isSpectator()) {
			...
			if (this.field_190598_h == 1) {
				this.world.playSound((EntityPlayer) null, this.pos, SoundEvents.field_191262_fB, SoundCategory.BLOCKS,
	...
	public void closeInventory(EntityPlayer player) {
		if (!player.isSpectator()) {
			...
			if (this.field_190598_h <= 0) {
				this.world.playSound((EntityPlayer) null, this.pos, SoundEvents.field_191261_fA, SoundCategory.BLOCKS,
						0.5F, this.world.rand.nextFloat() * 0.1F + 0.9F);
			}
		}
	}
	...
	public static void func_190593_a(DataFixer p_190593_0_) {
		p_190593_0_.registerWalker(FixTypes.BLOCK_ENTITY,
