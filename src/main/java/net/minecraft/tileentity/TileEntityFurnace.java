...
public class TileEntityFurnace extends TileEntityLockable implements ITickable, ISidedInventory {
	...
	public void readFromNBT(NBTTagCompound compound) {
		...
		this.furnaceItemStacks = NonNullList.<ItemStack>func_191197_a(this.getSizeInventory(),
				ItemStack.field_190927_a);
						...
						if (!itemstack.func_190926_b()) {
							...
							if (itemstack.func_190926_b()) {
								...
								this.furnaceItemStacks.set(1,
										item1 == null ? ItemStack.field_190927_a : new ItemStack(item1));
							}
						}
					}
				}
		...
		if (((ItemStack) this.furnaceItemStacks.get(0)).func_190926_b()) {
			...
			if (itemstack.func_190926_b()) {
				...
				if (itemstack1.func_190926_b()) {
					...
					return false;
				} else if (itemstack1.func_190916_E() < this.getInventoryStackLimit()
