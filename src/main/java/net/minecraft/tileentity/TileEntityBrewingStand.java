...
public class TileEntityBrewingStand extends TileEntityLockable implements ITickable, ISidedInventory {
	...
	private NonNullList<ItemStack> brewingItemStacks = NonNullList.<ItemStack>func_191197_a(5,
	...
	/**
	 * Creates an array of boolean values, each value represents a potion input
	 * slot, value is true if the slot is not null.
	 */
	...
	public void readFromNBT(NBTTagCompound compound) {
		...
		this.brewingItemStacks = NonNullList.<ItemStack>func_191197_a(this.getSizeInventory(),
				ItemStack.field_190927_a);
		...
		if (index == 3) {
			...
			if (index == 4) {
				...
				return (item == Items.POTIONITEM || item == Items.SPLASH_POTION || item == Items.LINGERING_POTION
						|| item == Items.GLASS_BOTTLE) && this.getStackInSlot(index).func_190926_b();
			}
		}
	}
