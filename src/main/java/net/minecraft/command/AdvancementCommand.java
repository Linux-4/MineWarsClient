...
public class AdvancementCommand extends CommandBase {
	...
	public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
		if (args.length < 1) {
			...
			AdvancementCommand.ActionType advancementcommand$actiontype = AdvancementCommand.ActionType
					.func_193536_a(args[0]);
			...
			if (advancementcommand$actiontype != null) {
				...
				this.func_193516_a(server, sender, args, entityplayermp, advancementcommand$actiontype,
				...
				if (args.length == 3) {
					...
					this.func_192554_c(sender, getPlayer(server, sender, args[1]), func_192551_a(server, args[2]),
							args[3]);
				}
			}
		}
	...
	private void func_193516_a(MinecraftServer p_193516_1_, ICommandSender p_193516_2_, String[] p_193516_3_,
			EntityPlayerMP p_193516_4_, AdvancementCommand.ActionType p_193516_5_, AdvancementCommand.Mode p_193516_6_)
		...
		if (p_193516_6_ == AdvancementCommand.Mode.EVERYTHING) {
			...
			if (p_193516_6_ == AdvancementCommand.Mode.ONLY && p_193516_3_.length == 5) {
				...
				if (!advancement.func_192073_f().keySet().contains(s)) {
					throw new CommandException("commands.advancement.criterionNotFound",
							new Object[] { advancement.func_192067_g(), p_193516_3_[4] });
				}

				if (!p_193516_5_.func_193535_a(p_193516_4_, advancement, s)) {
					throw new CommandException(p_193516_5_.field_193541_d + ".criterion.failed",
							new Object[] { advancement.func_192067_g(), p_193516_4_.getName(), s });
				}

				notifyCommandListener(p_193516_2_, this, p_193516_5_.field_193541_d + ".criterion.success",
						new Object[] { advancement.func_192067_g(), p_193516_4_.getName(), s });
			} else {
				...
				p_193516_6_.func_193546_a(p_193516_2_, this, p_193516_5_, advancement.func_192067_g(),
						p_193516_4_.getName(), i);
			}
		}
	}
	...
	private List<Advancement> func_193514_a(Advancement p_193514_1_, AdvancementCommand.Mode p_193514_2_) {
		...
		if (p_193514_2_.field_193555_h) {
			for (Advancement advancement = p_193514_1_.func_192070_b(); advancement != null; advancement = advancement
					.func_192070_b()) {
	...
	private void func_192554_c(ICommandSender p_192554_1_, EntityPlayerMP p_192554_2_, Advancement p_192554_3_,
		...
		if (criterionprogress == null) {
			throw new CommandException("commands.advancement.criterionNotFound",
					new Object[] { p_192554_3_.func_192067_g(), p_192554_4_ });
		} else if (!criterionprogress.func_192151_a()) {
			throw new CommandException("commands.advancement.test.criterion.notDone",
					new Object[] { p_192554_2_.getName(), p_192554_3_.func_192067_g(), p_192554_4_ });
		} else {
			notifyCommandListener(p_192554_1_, this, "commands.advancement.test.criterion.success",
					new Object[] { p_192554_2_.getName(), p_192554_3_.func_192067_g(), p_192554_4_ });
		}
	}

	private void func_192552_c(ICommandSender p_192552_1_, EntityPlayerMP p_192552_2_, Advancement p_192552_3_)
			throws CommandException {
		...
		if (!advancementprogress.func_192105_a()) {
			throw new CommandException("commands.advancement.test.advancement.notDone",
					new Object[] { p_192552_2_.getName(), p_192552_3_.func_192067_g() });
		} else {
			notifyCommandListener(p_192552_1_, this, "commands.advancement.test.advancement.success",
					new Object[] { p_192552_2_.getName(), p_192552_3_.func_192067_g() });
		}
	}
	...
	static enum ActionType {
		...
		protected abstract boolean func_193535_a(EntityPlayerMP p_193535_1_, Advancement p_193535_2_,
				String p_193535_3_);
	}
	...
	static enum Mode {
		...
		CommandException func_193543_a(AdvancementCommand.ActionType p_193543_1_, Object... p_193543_2_) {
			return new CommandException(p_193543_1_.field_193541_d + "." + this.field_193554_g + ".failed",
					p_193543_2_);
		}
		...
		void func_193546_a(ICommandSender p_193546_1_, AdvancementCommand p_193546_2_,
				AdvancementCommand.ActionType p_193546_3_, Object... p_193546_4_) {
			CommandBase.notifyCommandListener(p_193546_1_, p_193546_2_,
					p_193546_3_.field_193541_d + "." + this.field_193554_g + ".success", p_193546_4_);
		}
