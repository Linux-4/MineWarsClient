...
public class CommandDebug extends CommandBase {
	...
	private void appendProfilerResults(int p_184895_1_, String sectionName, StringBuilder builder,
		...
		if (list != null && list.size() >= 3) {
			for (int i = 1; i < list.size(); ++i) {
				...
				if (!"unspecified".equals(profiler$result.profilerName)) {
					try {
						this.appendProfilerResults(p_184895_1_ + 1, sectionName + "." + profiler$result.profilerName,
								builder, server);
