		...
		if (args.length < 1) {
			...
			if ("set".equals(args[0])) {
				...
				if ("time".equals(args[1])) {
					...
					notifyCommandListener(sender, this, "commands.worldborder.warning.time.success",
							new Object[] { j, l });
					...
					notifyCommandListener(sender, this, "commands.worldborder.warning.distance.success",
							new Object[] { k, i1 });
				}
			} else {
				...
				sender.addChatMessage(new TextComponentTranslation("commands.worldborder.get.success",
