	...
	public static boolean renderEndPortal(TileEntityEndPortal te, double x, double y, double z, float partialTicks,
		...
		if (!Shaders.isShadowPass && Shaders.programsID[Shaders.activeProgram] == 0) {
			...
			if (te.shouldRenderFace(EnumFacing.SOUTH)) {
				bufferbuilder.pos(x, y, z + 1.0D).color(f1, f2, f3, 1.0F).tex((double) (f4 + f6), (double) (f4 + f6))
						.lightmap(i, i).endVertex();
				bufferbuilder.pos(x + 1.0D, y, z + 1.0D).color(f1, f2, f3, 1.0F)
						.tex((double) (f4 + f6), (double) (f5 + f6)).lightmap(i, i).endVertex();
				bufferbuilder.pos(x + 1.0D, y + 1.0D, z + 1.0D).color(f1, f2, f3, 1.0F)
						.tex((double) (f5 + f6), (double) (f5 + f6)).lightmap(i, i).endVertex();
				bufferbuilder.pos(x, y + 1.0D, z + 1.0D).color(f1, f2, f3, 1.0F)
						.tex((double) (f5 + f6), (double) (f4 + f6)).lightmap(i, i).endVertex();
			}

			if (te.shouldRenderFace(EnumFacing.NORTH)) {
				bufferbuilder.pos(x, y + 1.0D, z).color(f1, f2, f3, 1.0F).tex((double) (f5 + f6), (double) (f5 + f6))
						.lightmap(i, i).endVertex();
				bufferbuilder.pos(x + 1.0D, y + 1.0D, z).color(f1, f2, f3, 1.0F)
						.tex((double) (f5 + f6), (double) (f4 + f6)).lightmap(i, i).endVertex();
				bufferbuilder.pos(x + 1.0D, y, z).color(f1, f2, f3, 1.0F).tex((double) (f4 + f6), (double) (f4 + f6))
						.lightmap(i, i).endVertex();
				bufferbuilder.pos(x, y, z).color(f1, f2, f3, 1.0F).tex((double) (f4 + f6), (double) (f5 + f6))
						.lightmap(i, i).endVertex();
			}
			...
			if (te.shouldRenderFace(EnumFacing.EAST)) {
				...
				bufferbuilder.pos(x + 1.0D, y + 1.0D, z + 1.0D).color(f1, f2, f3, 1.0F)
						.tex((double) (f5 + f6), (double) (f4 + f6)).lightmap(i, i).endVertex();
				bufferbuilder.pos(x + 1.0D, y, z + 1.0D).color(f1, f2, f3, 1.0F)
						.tex((double) (f4 + f6), (double) (f4 + f6)).lightmap(i, i).endVertex();
				bufferbuilder.pos(x + 1.0D, y, z).color(f1, f2, f3, 1.0F).tex((double) (f4 + f6), (double) (f5 + f6))
						.lightmap(i, i).endVertex();
			}

			if (te.shouldRenderFace(EnumFacing.WEST)) {
				bufferbuilder.pos(x, y, z).color(f1, f2, f3, 1.0F).tex((double) (f4 + f6), (double) (f4 + f6))
						.lightmap(i, i).endVertex();
				bufferbuilder.pos(x, y, z + 1.0D).color(f1, f2, f3, 1.0F).tex((double) (f4 + f6), (double) (f5 + f6))
						.lightmap(i, i).endVertex();
				bufferbuilder.pos(x, y + 1.0D, z + 1.0D).color(f1, f2, f3, 1.0F)
						.tex((double) (f5 + f6), (double) (f5 + f6)).lightmap(i, i).endVertex();
				bufferbuilder.pos(x, y + 1.0D, z).color(f1, f2, f3, 1.0F).tex((double) (f5 + f6), (double) (f4 + f6))
						.lightmap(i, i).endVertex();
			}
			...
			if (te.shouldRenderFace(EnumFacing.DOWN)) {
				...
				bufferbuilder.pos(x + 1.0D, y, z + 1.0D).color(f1, f2, f3, 1.0F)
						.tex((double) (f5 + f6), (double) (f5 + f6)).lightmap(i, i).endVertex();
				bufferbuilder.pos(x, y, z + 1.0D).color(f1, f2, f3, 1.0F).tex((double) (f5 + f6), (double) (f4 + f6))
						.lightmap(i, i).endVertex();
			}

			if (te.shouldRenderFace(EnumFacing.UP)) {
				bufferbuilder.pos(x, y + (double) offset, z + 1.0D).color(f1, f2, f3, 1.0F)
						.tex((double) (f4 + f6), (double) (f4 + f6)).lightmap(i, i).endVertex();
				bufferbuilder.pos(x + 1.0D, y + (double) offset, z + 1.0D).color(f1, f2, f3, 1.0F)
						.tex((double) (f4 + f6), (double) (f5 + f6)).lightmap(i, i).endVertex();
				bufferbuilder.pos(x + 1.0D, y + (double) offset, z).color(f1, f2, f3, 1.0F)
						.tex((double) (f5 + f6), (double) (f5 + f6)).lightmap(i, i).endVertex();
				bufferbuilder.pos(x, y + (double) offset, z).color(f1, f2, f3, 1.0F)
						.tex((double) (f5 + f6), (double) (f4 + f6)).lightmap(i, i).endVertex();
			}
