...
public class SimpleShaderTexture extends AbstractTexture {
	...
	private TextureMetadataSection loadTextureMetadataSection() {
		...
		if (inputstream != null) {
			...
			try {
				...
				TextureMetadataSection texturemetadatasection = (TextureMetadataSection) metadataserializer
	...
	private static MetadataSerializer makeMetadataSerializer() {
		...
		metadataserializer.registerMetadataSectionType(new TextureMetadataSectionSerializer(),
		...
		metadataserializer.registerMetadataSectionType(new AnimationMetadataSectionSerializer(),
		...
		metadataserializer.registerMetadataSectionType(new LanguageMetadataSectionSerializer(),
