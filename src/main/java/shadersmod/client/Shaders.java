							...
							if (shaderline.isUniform()) {
								...
								if (!shaderline.isConstFloat("shadowMapFov") && !shaderline.isComment("SHADOWFOV")) {
									if (!shaderline.isConstFloat("shadowDistance")
										...
										} else if (shaderline.isConstBool("shadowcolor0Mipmap", "shadowColor0Mipmap",
												true)) {
											shadowColorMipmapEnabled[0] = true;
											SMCLog.info("shadowcolor0Mipmap");
										} else if (shaderline.isConstBool("shadowcolor1Mipmap", "shadowColor1Mipmap",
												true)) {
										...
										} else if (shaderline.isConstBool("shadowtex1Nearest", "shadow1MinMagNearest",
												true)) {
