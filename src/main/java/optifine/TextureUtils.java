...
public class TextureUtils {
	...
	public static ResourceLocation fixResourceLocation(ResourceLocation p_fixResourceLocation_0_,
			String p_fixResourceLocation_1_) {
	...
	public static void generateCustomMipmaps(TextureAtlasSprite p_generateCustomMipmaps_0_,
			int p_generateCustomMipmaps_1_) {
	...
	public static int[] getFrameData(TextureAtlasSprite p_getFrameData_0_, int p_getFrameData_1_,
			int p_getFrameData_2_) {
