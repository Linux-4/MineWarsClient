...
public class ConnectedParser {
	...
	public BlockRenderLayer parseBlockRenderLayer(String p_parseBlockRenderLayer_1_,
			BlockRenderLayer p_parseBlockRenderLayer_2_) {
	...
	public Enum[] parseEnums(String p_parseEnums_1_, Enum[] p_parseEnums_2_, String p_parseEnums_3_,
			Enum[] p_parseEnums_4_) {
