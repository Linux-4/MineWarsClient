...
public class StrUtils {
	...
	public static String replacePrefix(String p_replacePrefix_0_, String p_replacePrefix_1_,
			String p_replacePrefix_2_) {
	...
	public static String addSuffixCheck(String p_addSuffixCheck_0_, String p_addSuffixCheck_1_) {
		if (p_addSuffixCheck_0_ != null && p_addSuffixCheck_1_ != null) {
			return p_addSuffixCheck_0_.endsWith(p_addSuffixCheck_1_) ? p_addSuffixCheck_0_
					: p_addSuffixCheck_0_ + p_addSuffixCheck_1_;
		} else {
	...
	public static String addPrefixCheck(String p_addPrefixCheck_0_, String p_addPrefixCheck_1_) {
		if (p_addPrefixCheck_0_ != null && p_addPrefixCheck_1_ != null) {
			return p_addPrefixCheck_0_.endsWith(p_addPrefixCheck_1_) ? p_addPrefixCheck_0_
					: p_addPrefixCheck_1_ + p_addPrefixCheck_0_;
		} else {
