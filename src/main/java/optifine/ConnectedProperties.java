...
public class ConnectedProperties {
	...
	public ConnectedProperties(Properties p_i27_1_, String p_i27_2_) {
		...
		this.tintBlockState = connectedparser.parseBlockState(p_i27_1_.getProperty("tintBlock"),
				Blocks.AIR.getDefaultState());
		this.layer = connectedparser.parseBlockRenderLayer(p_i27_1_.getProperty("layer"),
