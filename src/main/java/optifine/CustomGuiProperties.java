...
public class CustomGuiProperties {
	...
	public CustomGuiProperties(Properties p_i32_1_, String p_i32_2_) {
		...
		this.container = (CustomGuiProperties.EnumContainer) connectedparser
				.parseEnum(p_i32_1_.getProperty("container"), CustomGuiProperties.EnumContainer.values(), "container");
		this.textureLocations = parseTextureLocations(p_i32_1_, "texture", this.container, "textures/gui/",
				this.basePath);
		...
		this.variants = (CustomGuiProperties.EnumVariant[]) connectedparser.parseEnums(p_i32_1_.getProperty("variants"),
				acustomguiproperties$enumvariant, "variants", VARIANTS_INVALID);
		this.colors = parseEnumDyeColors(p_i32_1_.getProperty("colors"));
	}

	private static CustomGuiProperties.EnumVariant[] getContainerVariants(
			CustomGuiProperties.EnumContainer p_getContainerVariants_0_) {
		if (p_getContainerVariants_0_ == CustomGuiProperties.EnumContainer.HORSE) {
			return VARIANTS_HORSE;
		} else {
			return p_getContainerVariants_0_ == CustomGuiProperties.EnumContainer.DISPENSER ? VARIANTS_DISPENSER
	...
	private static NbtTagValue parseNbtTagValue(String p_parseNbtTagValue_0_, String p_parseNbtTagValue_1_) {
		return p_parseNbtTagValue_0_ != null && p_parseNbtTagValue_1_ != null
				? new NbtTagValue(p_parseNbtTagValue_0_, p_parseNbtTagValue_1_)
				: null;
	}
	...
	private static ResourceLocation parseTextureLocation(String p_parseTextureLocation_0_,
			String p_parseTextureLocation_1_) {
	...
	private static Map<ResourceLocation, ResourceLocation> parseTextureLocations(Properties p_parseTextureLocations_0_,
			String p_parseTextureLocations_1_, CustomGuiProperties.EnumContainer p_parseTextureLocations_2_,
			String p_parseTextureLocations_3_, String p_parseTextureLocations_4_) {
	...
	private static ResourceLocation getGuiTextureLocation(
			CustomGuiProperties.EnumContainer p_getGuiTextureLocation_0_) {
	...
	private boolean matchesGeneral(CustomGuiProperties.EnumContainer p_matchesGeneral_1_, BlockPos p_matchesGeneral_2_,
			IBlockAccess p_matchesGeneral_3_) {
	...
	public boolean matchesPos(CustomGuiProperties.EnumContainer p_matchesPos_1_, BlockPos p_matchesPos_2_,
			IBlockAccess p_matchesPos_3_) {
	...
	private boolean matchesChest(TileEntityChest p_matchesChest_1_, BlockPos p_matchesChest_2_,
			IBlockAccess p_matchesChest_3_) {
		boolean flag = p_matchesChest_1_.adjacentChestXNeg != null || p_matchesChest_1_.adjacentChestXPos != null
				|| p_matchesChest_1_.adjacentChestZNeg != null || p_matchesChest_1_.adjacentChestZPos != null;
	...
	private boolean matchesEnderChest(TileEntityEnderChest p_matchesEnderChest_1_, BlockPos p_matchesEnderChest_2_,
			IBlockAccess p_matchesEnderChest_3_) {
		return this.matchesChest(false, false, false, true, (String) null);
	}

	private boolean matchesChest(boolean p_matchesChest_1_, boolean p_matchesChest_2_, boolean p_matchesChest_3_,
			boolean p_matchesChest_4_, String p_matchesChest_5_) {
	...
	private CustomGuiProperties.EnumVariant getDispenserVariant(TileEntityDispenser p_getDispenserVariant_1_) {
		return p_getDispenserVariant_1_ instanceof TileEntityDropper ? CustomGuiProperties.EnumVariant.DROPPER
	...
	public boolean matchesEntity(CustomGuiProperties.EnumContainer p_matchesEntity_1_, Entity p_matchesEntity_2_,
			IBlockAccess p_matchesEntity_3_) {
