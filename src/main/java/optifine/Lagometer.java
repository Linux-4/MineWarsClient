...
public class Lagometer {
	...
	private static long renderTime(int p_renderTime_0_, long p_renderTime_1_, int p_renderTime_3_, int p_renderTime_4_,
			int p_renderTime_5_, float p_renderTime_6_, BufferBuilder p_renderTime_7_) {
	...
	private static long renderTimeDivider(int p_renderTimeDivider_0_, int p_renderTimeDivider_1_,
			...
			int p_renderTimeDivider_6_, float p_renderTimeDivider_7_, BufferBuilder p_renderTimeDivider_8_) {
