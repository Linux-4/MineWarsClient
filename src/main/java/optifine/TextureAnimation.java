...
public class TextureAnimation {
	...
	public TextureAnimation(String p_i97_1_, byte[] p_i97_2_, String p_i97_3_, ResourceLocation p_i97_4_, int p_i97_5_,
			int p_i97_6_, int p_i97_7_, int p_i97_8_, Properties p_i97_9_, int p_i97_10_) {
		...
		if (p_i97_2_.length % i != 0) {
			Config.warn("Invalid animated texture length: " + p_i97_2_.length + ", frameWidth: " + p_i97_7_
