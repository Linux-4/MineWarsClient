...
public class RenderEnv {
	...
	public EnumFacing[] getBorderDirections(EnumFacing p_getBorderDirections_1_, EnumFacing p_getBorderDirections_2_,
			EnumFacing p_getBorderDirections_3_, EnumFacing p_getBorderDirections_4_) {
	...
	public BakedQuad[] getArrayQuadsCtm(BakedQuad p_getArrayQuadsCtm_1_, BakedQuad p_getArrayQuadsCtm_2_,
			BakedQuad p_getArrayQuadsCtm_3_) {
	...
	public BakedQuad[] getArrayQuadsCtm(BakedQuad p_getArrayQuadsCtm_1_, BakedQuad p_getArrayQuadsCtm_2_,
			BakedQuad p_getArrayQuadsCtm_3_, BakedQuad p_getArrayQuadsCtm_4_) {
