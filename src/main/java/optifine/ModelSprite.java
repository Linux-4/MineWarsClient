...
public class ModelSprite {
	...
	public static void renderItemIn2D(Tessellator p_renderItemIn2D_0_, float p_renderItemIn2D_1_,
		...
		GL11.glNormal3f(0.0F, 0.0F, 1.0F);
		bufferbuilder.begin(7, DefaultVertexFormats.POSITION_TEX);
		bufferbuilder.pos(0.0D, 0.0D, (double) p_renderItemIn2D_7_)
				.tex((double) p_renderItemIn2D_1_, (double) p_renderItemIn2D_2_).endVertex();
		bufferbuilder.pos(d0, 0.0D, (double) p_renderItemIn2D_7_)
				.tex((double) p_renderItemIn2D_3_, (double) p_renderItemIn2D_2_).endVertex();
		bufferbuilder.pos(d0, d1, (double) p_renderItemIn2D_7_)
				.tex((double) p_renderItemIn2D_3_, (double) p_renderItemIn2D_4_).endVertex();
		bufferbuilder.pos(0.0D, d1, (double) p_renderItemIn2D_7_)
		...
		for (int i = 0; i < p_renderItemIn2D_5_; ++i) {
			...
			bufferbuilder.pos((double) f4 * d0, d1, (double) p_renderItemIn2D_7_)
			...
			bufferbuilder.pos((double) f4 * d0, 0.0D, (double) p_renderItemIn2D_7_)
		...
		for (int j = 0; j < p_renderItemIn2D_5_; ++j) {
			...
			bufferbuilder.pos((double) f6 * d0, 0.0D, (double) p_renderItemIn2D_7_)
			...
			bufferbuilder.pos((double) f6 * d0, d1, (double) p_renderItemIn2D_7_)
		...
		for (int k = 0; k < p_renderItemIn2D_6_; ++k) {
			...
			bufferbuilder.pos(0.0D, (double) f13 * d1, (double) p_renderItemIn2D_7_)
					.tex((double) p_renderItemIn2D_1_, (double) f11).endVertex();
			bufferbuilder.pos(d0, (double) f13 * d1, (double) p_renderItemIn2D_7_)
			...
			bufferbuilder.pos(0.0D, (double) f13 * d1, 0.0D).tex((double) p_renderItemIn2D_1_, (double) f11)
					.endVertex();
		}
		...
		for (int l = 0; l < p_renderItemIn2D_6_; ++l) {
			...
			bufferbuilder.pos(d0, (double) f9 * d1, (double) p_renderItemIn2D_7_)
					.tex((double) p_renderItemIn2D_3_, (double) f12).endVertex();
			bufferbuilder.pos(0.0D, (double) f9 * d1, (double) p_renderItemIn2D_7_)
