...
public class PlayerItemParser {
	...
	public static PlayerItemModel parseItemModel(JsonObject p_parseItemModel_0_) {
		...
		if (!Config.equals(s, "PlayerItem")) {
			...
			PlayerItemRenderer[] aplayeritemrenderer = (PlayerItemRenderer[]) list
	...
	public static PlayerItemRenderer parseItemRenderer(JsonObject p_parseItemRenderer_0_,
		...
		if (!Config.equals(s, "ModelBox")) {
			...
			ModelRenderer modelrenderer = parseModelRenderer(p_parseItemRenderer_0_, modelbase, (int[]) null,
					(String) null);
	...
	public static ModelRenderer parseModelRenderer(JsonObject p_parseModelRenderer_0_,
			ModelBase p_parseModelRenderer_1_, int[] p_parseModelRenderer_2_, String p_parseModelRenderer_3_) {
		...
		if (s1 != null) {
			modelrenderer.setTextureLocation(
					CustomEntityModelParser.getResourceLocation(p_parseModelRenderer_3_, s1, ".png"));
		}
		...
		if (jsonarray != null) {
			for (int j = 0; j < jsonarray.size(); ++j) {
				...
				if (aint2 != null) {
					modelrenderer.addBox(aint2, afloat2[0], afloat2[1], afloat2[2], afloat2[3], afloat2[4], afloat2[5],
							f1);
				} else {
		...
		if (jsonobject1 != null) {
			ModelRenderer modelrenderer2 = parseModelRenderer(jsonobject1, p_parseModelRenderer_1_, aint,
					p_parseModelRenderer_3_);
		...
		if (jsonarray2 != null) {
			for (int l = 0; l < jsonarray2.size(); ++l) {
				...
				ModelRenderer modelrenderer3 = parseModelRenderer(jsonobject3, p_parseModelRenderer_1_, aint,
						p_parseModelRenderer_3_);
	...
	private static int[][] parseFaceUvs(JsonObject p_parseFaceUvs_0_) {
		int[][] aint = new int[][] { Json.parseIntArray(p_parseFaceUvs_0_.get("uvDown"), 4),
				Json.parseIntArray(p_parseFaceUvs_0_.get("uvUp"), 4),
				Json.parseIntArray(p_parseFaceUvs_0_.get("uvNorth"), 4),
				Json.parseIntArray(p_parseFaceUvs_0_.get("uvSouth"), 4),
				Json.parseIntArray(p_parseFaceUvs_0_.get("uvWest"), 4),
				Json.parseIntArray(p_parseFaceUvs_0_.get("uvEast"), 4) };
