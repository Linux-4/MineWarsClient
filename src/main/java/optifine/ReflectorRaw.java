...
public class ReflectorRaw {
	...
	public static Field[] getFieldsAfter(Class p_getFieldsAfter_0_, Field p_getFieldsAfter_1_,
			Class p_getFieldsAfter_2_) {
		try {
	...
	public static Field[] getFields(Object p_getFields_0_, Field[] p_getFields_1_, Class p_getFields_2_,
			Object p_getFields_3_) {
		try {
	...
	public static Field getFieldAfter(Class p_getFieldAfter_0_, Field p_getFieldAfter_1_, Class p_getFieldAfter_2_,
			int p_getFieldAfter_3_) {
	...
	public static boolean setFieldValue(Object p_setFieldValue_0_, Class p_setFieldValue_1_, Class p_setFieldValue_2_,
			Object p_setFieldValue_3_) {
		ReflectorField reflectorfield = getReflectorField(p_setFieldValue_1_, p_setFieldValue_2_);

		if (reflectorfield == null) {
			return false;
		} else {
			return !reflectorfield.exists() ? false
					: Reflector.setFieldValue(p_setFieldValue_0_, reflectorfield, p_setFieldValue_3_);
		}
	}

	public static boolean setFieldValue(Object p_setFieldValue_0_, Class p_setFieldValue_1_, Class p_setFieldValue_2_,
			int p_setFieldValue_3_, Object p_setFieldValue_4_) {
		...
		if (reflectorfield == null) {
			...
			return !reflectorfield.exists() ? false
					: Reflector.setFieldValue(p_setFieldValue_0_, reflectorfield, p_setFieldValue_4_);
		}
	}
